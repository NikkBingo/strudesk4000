...
export class UserProfilesListing {
  ...
  getSocialIcon(platform) {
    const icons = {
      ...
      soundcloud: `<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M1.175 13.5c-.619 0-1.125-.506-1.125-1.125s.506-1.125 1.125-1.125h1.125v2.25H1.175zm2.25-3c-.619 0-1.125-.506-1.125-1.125S2.806 8.25 3.425 8.25h1.125v2.25H3.425zm2.25-2.25c-.619 0-1.125-.506-1.125-1.125S5.056 6 5.675 6h1.125v2.25H5.675zm2.25-1.5c-.619 0-1.125-.506-1.125-1.125S7.306 4.5 7.925 4.5H9.05v2.25H7.925zm2.25-1.5c-.619 0-1.125-.506-1.125-1.125S9.556 3 10.175 3h1.125v2.25h-1.125zm2.25 0c-.619 0-1.125-.506-1.125-1.125S11.806 3 12.425 3h1.125v2.25h-1.125zm2.25 1.5c-.619 0-1.125-.506-1.125-1.125S14.056 4.5 14.675 4.5h1.125v2.25h-1.125zm2.25 1.5c-.619 0-1.125-.506-1.125-1.125S16.306 6 16.925 6h1.125v2.25h-1.125zm2.25 2.25c-.619 0-1.125-.506-1.125-1.125S18.556 8.25 19.175 8.25h1.125v2.25h-1.125zm2.25 3c-.619 0-1.125-.506-1.125-1.125S20.806 11.25 21.425 11.25h1.125v2.25h-1.125z"/></svg>`,
      bandcamp: `<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M0 18.75l7.5-7.5L0 3.75V0h24v3.75L16.5 11.25l7.5 7.5V24H0v-5.25z"/></svg>`,
