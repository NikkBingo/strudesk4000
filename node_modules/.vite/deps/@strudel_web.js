...
Ue.key = wu;
var Ly = (e) => /^[a-gA-G][#bs]*[0-9]$/.test(e);
var Un = (e) => /^[a-gA-G][#bsf]*[0-9]?$/.test(e);
var vc = (e) => {
  var _a2;
  if (typeof e != "string")
    return [];
  const [t, n = "", r] = ((_a2 = e.match(/^([a-gA-G])([#bsf]*)([0-9]*)$/)) == null ? void 0 : _a2.slice(1)) || [];
  return t ? [t, n, r ? Number(r) : void 0] : [];
};
var Ry = { c: 0, d: 2, e: 4, f: 5, g: 7, a: 9, b: 11 };
var Gy = { "#": 1, b: -1, s: 1, f: -1 };
var Ln = (e, t = 3) => {
  const [n, r, i = t] = vc(e);
  if (!n)
    throw new Error('not a note: "' + e + '"');
  const s = Ry[n.toLowerCase()], u = (r == null ? void 0 : r.split("").reduce((a, o) => a + Gy[o], 0)) || 0;
  return (Number(i) + 1) * 12 + s + u;
};
var Hn = (e) => Math.pow(2, (e - 69) / 12) * 440;
...
var Xy = (e, t) => (e - t) * 1e3;
var Pc = (e) => Hn(typeof e == "number" ? e : Ln(e));
var Wy = ["C", "Db", "D", "Eb", "E", "F", "Gb", "G", "Ab", "A", "Bb", "B"];
var Oy = (e) => {
  const t = Math.floor(e / 12) - 1;
  return Wy[e % 12] + t;
};
var kt = (e, t) => (e % t + t) % t;
var Dc = (e) => e.reduce((t, n) => t + n) / e.length;
function Fc(e, t = 0) {
  return isNaN(Number(e)) ? (Ue(`"${e}" is not a number, falling back to ${t}`, "warning"), t) : e;
}
var zy = (e, t) => kt(Math.round(Fc(e ?? 0, 0)), t);
var jy = (e) => {
...
var xc = (e, t) => e.slice(t).concat(e.slice(0, t));
var wc = (...e) => e.reduce(
  (t, n) => (...r) => t(n(...r)),
  (t) => t
);
var $y = (...e) => wc(...e.reverse());
var Cr = (e) => e.filter((t) => t != null);
var bn = (e) => [].concat(...e);
var hr = (e) => e;
var qy = (e, t) => e;
var _u = (e, t) => Array.from({ length: t - e + 1 }, (n, r) => r + e);
...
var qi = (e, t, n) => t.map((r, i) => e(r, n[i]));
var Bc = function(e) {
  const t = [];
...
var Hi = (e, t, n) => Math.min(Math.max(e, t), n);
var Ky = ["Do", "Reb", "Re", "Mib", "Mi", "Fa", "Solb", "Sol", "Lab", "La", "Sib", "Si"];
var Yy = [
  "Sa",
  "Re",
  "Ga",
...
var Jy = ["C", "Db", "D", "Eb", "E", "F", "Gb", "G", "Ab", "A", "Hb", "H"];
var Uy = [
  "Ni",
  "Pab",
  "Pa",
...
var e3 = ["C", "Db", "D", "Eb", "E", "F", "Gb", "G", "Ab", "A", "Bb", "B"];
var t3 = (e, t = "letters") => {
...
var He = class _He {
  ...
  get spanCycles() {
    ...
    for (; r.gt(n); ) {
      if (n.sam().equals(i)) {
        t.push(new _He(n, this.end));
        break;
      }
      const s = n.nextSam();
      t.push(new _He(n, s)), n = s;
    }
    return t;
  }
  get duration() {
  ...
  withTime(t) {
    return new _He(t(this.begin), t(this.end));
  }
  withEnd(t) {
    return new _He(this.begin, t(this.end));
  }
  withCycle(t) {
...
var je = class _je {
  ...
  get duration() {
    var _a2, _b2;
    let t;
    return typeof ((_a2 = this.value) == null ? void 0 : _a2.duration) == "number" ? t = j(this.value.duration) : t = this.whole.end.sub(this.whole.begin), typeof ((_b2 = this.value) == null ? void 0 : _b2.clip) == "number" ? t.mul(this.value.clip) : t;
  }
  get endClipped() {
  ...
  withSpan(t) {
    ...
    return new _je(n, t(this.part), this.value, this.context);
  }
  withValue(t) {
    return new _je(this.whole, this.part, t(this.value), this.context);
  }
  hasOnset() {
  ...
  resolveState(t) {
    if (this.stateful && this.hasOnset()) {
      ...
      return [r, new _je(this.whole, this.part, i, this.context, false)];
    }
    return [t, this];
  }
  spanEquals(t) {
  ...
  setContext(t) {
    return new _je(this.whole, this.part, this.value, t);
  }
  ensureObjectValue() {
...
var gr = class _gr {
  ...
  setSpan(t) {
    return new _gr(t, this.controls);
  }
  withSpan(t) {
...
var $ = class it {
  ...
  defragmentHaps() {
    return this.discreteOnly().withHaps((n) => {
      ...
      for (var i = 0; i < n.length; ++i) {
        for (var s = true, u = n[i]; s; ) {
          const f = JSON.stringify(n[i].value);
          for (var a = false, o = i + 1; o < n.length; o++) {
            const h = n[o];
            if (u.whole.equals(h.whole)) {
              if (u.part.begin.eq(h.part.end)) {
                if (f === JSON.stringify(h.value)) {
                  u = new je(u.whole, new He(h.part.begin, u.part.end), u.value), n.splice(o, 1), a = true;
                  break;
                }
              } else if (h.part.begin.eq(u.part.end) && f == JSON.stringify(h.value)) {
                u = new je(u.whole, new He(u.part.begin, h.part.end), u.value), n.splice(o, 1), a = true;
                break;
              }
            }
          }
  ...
  onTrigger(t, n = true) {
    return this.withHap(
      (r) => r.setContext({
        ...
        onTrigger: (...i) => {
          var _a2, _b2;
          (_b2 = (_a2 = r.context).onTrigger) == null ? void 0 : _b2.call(_a2, ...i), t(...i);
        },
   ...
   * s("bd sd").log()
   */
  log(t = (r) => `[hap] ${r.showWhole(true)}`, n = (r) => ({ hap: r })) {
...
var h3 = (e, t) => e.spanEquals(t);
$.prototype.collect = function() {
  return this.withHaps(
    (e) => f3(h3, e).map((t) => new je(t[0].whole, t[0].part, t, {}))
  );
};
var p3 = N("arpWith", (e, t) => t.collect().fmap((n) => q(e(n))).innerJoin().withHap((n) => new je(n.whole, n.part, n.value.value, n.combineContext(n.value))));
var d3 = N(
  "arp",
...
function Nu(e) {
  return e instanceof $ || (e == null ? void 0 : e._Pattern);
}
function q(e) {
...
function Ru(...e) {
  ...
  const t = function(n) {
    ...
    return ((_a2 = e[r]) == null ? void 0 : _a2.query(n)) || [];
  };
...
var v3 = Ae((e, t) => q(t).mask(e));
var P3 = Ae((e, t) => q(t).struct(e));
var D3 = Ae((e, t) => q(t).superimpose(...e));
var F3 = Ae((e, t) => q(t).withValue(e));
var E3 = Ae((e, t) => q(t).bind(e));
var x3 = Ae((e, t) => q(t).innerBind(e));
var w3 = Ae((e, t) => q(t).outerBind(e));
var S3 = Ae((e, t) => q(t).squeezeBind(e));
var B3 = Ae((e, t) => q(t).stepBind(e));
var _3 = Ae((e, t) => q(t).polyBind(e));
var k3 = Ae((e, t) => q(t).set(e));
var V3 = Ae((e, t) => q(t).keep(e));
var I3 = Ae((e, t) => q(t).keepif(e));
var T3 = Ae((e, t) => q(t).add(e));
var N3 = Ae((e, t) => q(t).sub(e));
var L3 = Ae((e, t) => q(t).mul(e));
var R3 = Ae((e, t) => q(t).div(e));
var G3 = Ae((e, t) => q(t).mod(e));
var Z3 = Ae((e, t) => q(t).pow(e));
var X3 = Ae((e, t) => q(t).band(e));
var W3 = Ae((e, t) => q(t).bor(e));
var O3 = Ae((e, t) => q(t).bxor(e));
var z3 = Ae((e, t) => q(t).blshift(e));
var j3 = Ae((e, t) => q(t).brshift(e));
var $3 = Ae((e, t) => q(t).lt(e));
var q3 = Ae((e, t) => q(t).gt(e));
var H3 = Ae((e, t) => q(t).lte(e));
var K3 = Ae((e, t) => q(t).gte(e));
var Y3 = Ae((e, t) => q(t).eq(e));
var J3 = Ae((e, t) => q(t).eqt(e));
var U3 = Ae((e, t) => q(t).ne(e));
var Q3 = Ae((e, t) => q(t).net(e));
var eA = Ae((e, t) => q(t).and(e));
var tA = Ae((e, t) => q(t).or(e));
var nA = Ae((e, t) => q(t).func(e));
function N(e, t, n = true, r = false, i = (s) => s.innerJoin()) {
  if (Array.isArray(e)) {
    const a = {};
    for (const o of e)
      a[o] = N(o, t, n, r, i);
...
function ci(e, t, n = true, r = false, i = (s) => s.stepJoin()) {
  return N(e, t, n, r, i);
}
var rA = N("round", function(e) {
  return e.asNumber().fmap((t) => Math.round(t));
});
var iA = N("floor", function(e) {
  return e.asNumber().fmap((t) => Math.floor(t));
});
var sA = N("ceil", function(e) {
  return e.asNumber().fmap((t) => Math.ceil(t));
});
var uA = N("toBipolar", function(e) {
  return e.fmap((t) => t * 2 - 1);
});
var aA = N("fromBipolar", function(e) {
  return e.fmap((t) => (t + 1) / 2);
});
var oA = N("range", function(e, t, n) {
  return n.mul(t - e).add(e);
});
var cA = N("rangex", function(e, t, n) {
  return n._range(Math.log(e), Math.log(t)).fmap(Math.exp);
});
var lA = N("range2", function(e, t, n) {
...
var hA = N("compress", function(e, t, n) {
  return e = j(e), t = j(t), e.gt(t) || e.gt(1) || t.gt(1) || e.lt(0) || t.lt(0) ? Se : n._fastGap(j(1).div(t.sub(e)))._late(e);
});
var { compressSpan: pA, compressspan: dA } = N(["compressSpan", "compressspan"], function(e, t) {
  return t._compress(e.begin, e.end);
});
var { fastGap: mA, fastgap: gA } = N(["fastGap", "fastgap"], function(e, t) {
  const n = function(i) {
...
var vA = N("hurry", function(e, t) {
  return t._fast(e).mul(Je({ speed: e }));
});
var { slow: PA, sparsity: DA } = N(["slow", "sparsity"], function(e, t) {
  return e === 0 ? Se : t._fast(j(1).div(e));
});
var FA = N("inside", function(e, t, n) {
  return t(n._slow(e))._fast(e);
});
var EA = N("outside", function(e, t, n) {
  return t(n._fast(e))._slow(e);
});
var xA = N("lastOf", function(e, t, n) {
  const r = Array(e - 1).fill(n);
  return r.push(t(n)), Ru(...r);
});
var { firstOf: wA, every: SA } = N(["firstOf", "every"], function(e, t, n) {
  const r = Array(e - 1).fill(n);
  return r.unshift(t(n)), Ru(...r);
});
var BA = N("apply", function(e, t) {
  return e(t);
});
var _A = N("cpm", function(e, t) {
...
var VA = N("zoom", function(e, t, n) {
  var _a2;
  if (t = j(t), e = j(e), e.gte(t))
    return Dt;
  const r = t.sub(e), i = $t ? (_a2 = n._steps) == null ? void 0 : _a2.mulmaybe(r) : void 0;
  return n.withQuerySpan((s) => s.withCycle((u) => u.mul(r).add(e))).withHapSpan((s) => s.withCycle((u) => u.sub(e).div(r))).splitQueries().setSteps(i);
});
var { zoomArc: IA, zoomarc: TA } = N(["zoomArc", "zoomarc"], function(e, t) {
...
var { segment: RA, seg: GA } = N(["segment", "seg"], function(e, t) {
  return t.struct(Je(true)._fast(e)).setSteps(e);
});
var ZA = N("swingBy", (e, t, n) => n.inside(t, $c(jc(0, e / 2))));
var XA = N("swing", (e, t) => t.swingBy(1 / 3, e));
var { invert: WA, inv: OA } = N(
  ["invert", "inv"],
  function(e) {
    return e.fmap((t) => !t);
  },
...
var zA = N("when", function(e, t, n) {
  return e ? t(n) : n;
});
var jA = N("off", function(e, t, n) {
  return Le(n, t(n.late(e)));
});
var $A = N("brak", function(e) {
  return e.when(Rn(false, true), (t) => ot(t, Se)._late(0.25));
});
var qc = N(
  "rev",
  function(e) {
...
var qA = N("pressBy", function(e, t) {
  return t.fmap((n) => Je(n).compress(e, 1)).squeezeJoin();
});
var HA = N("press", function(e) {
...
var { juxBy: YA, juxby: JA } = N(["juxBy", "juxby"], function(e, t, n) {
  e /= 2;
...
var UA = N("jux", function(e, t) {
  return t._juxBy(1, e, t);
});
var { echoWith: QA, echowith: eb, stutWith: tb, stutwith: nb } = N(
  ["echoWith", "echowith", "stutWith", "stutwith"],
  function(e, t, n, r) {
    return Le(..._u(0, e - 1).map((i) => n(r.late(j(t).mul(i)), i)));
  }
);
var rb = N("echo", function(e, t, n, r) {
  return r._echoWith(e, t, (i, s) => i.gain(Math.pow(n, s)));
});
var ib = N("stut", function(e, t, n, r) {
  return r._echoWith(e, n, (i, s) => i.gain(Math.pow(t, s)));
});
var Gu = function(e, t, n = false) {
  return e = j(e), Rn(
    ..._u(0, e.sub(1)).map(
...
var Zu = function(e, t, n, r = false, i = false) {
  const s = Array(e - 1).fill(false);
  s.unshift(true);
  const u = Gu(e, qt(...s), !r);
  return i || (n = n.repeatCycles(e)), n.when(u, t);
};
var { chunk: cb, slowchunk: lb, slowChunk: fb } = N(
  ["chunk", "slowchunk", "slowChunk"],
  function(e, t, n) {
    return Zu(e, t, n, false, false);
  },
  true,
  true
);
var { chunkBack: hb, chunkback: pb } = N(
  ["chunkBack", "chunkback"],
  function(e, t, n) {
    return Zu(e, t, n, true);
  },
  true,
  true
);
var { fastchunk: db, fastChunk: mb } = N(
  ["fastchunk", "fastChunk"],
  function(e, t, n) {
    return Zu(e, t, n, false, true);
  },
  true,
  true
);
var { chunkinto: gb, chunkInto: yb } = N(["chunkinto", "chunkInto"], function(e, t, n) {
  return n.into(ot(true, ...Array(e - 1).fill(false))._iterback(e), t);
});
var { chunkbackinto: Ab, chunkBackInto: bb } = N(["chunkbackinto", "chunkBackInto"], function(e, t, n) {
  return n.into(
    ot(true, ...Array(e - 1).fill(false))._iter(e)._early(1),
    t
  );
});
var Mb = N(
...
var { ribbon: Cb, rib: vb } = N(
  ["ribbon", "rib"],
  (e, t, n) => n.early(e).restart(Je(1).slow(t))
);
var Pb = N("hsla", (e, t, n, r, i) => i.color(`hsla(${e}turn,${t * 100}%,${n * 100}%,${r})`));
var Db = N("hsl", (e, t, n, r) => r.color(`hsl(${e}turn,${t * 100}%,${n * 100}%)`));
$.prototype.tag = function(e) {
  return this.withContext((t) => ({ ...t, tags: (t.tags || []).concat([e]) }));
};
var Fb = N("filter", (e, t) => t.withHaps((n) => n.filter(e)));
var Eb = N("filterWhen", (e, t) => t.filter((n) => e(n.whole.begin)));
var xb = N(
  "within",
  (e, t, n, r) => Le(
...
var { loopAt: $b, loopat: qb } = N(["loopAt", "loopat"], function(e, t) {
...
var { loopAtCps: Kb, loopatcps: Yb } = N(["loopAtCps", "loopatcps"], function(e, t, n) {
  return ol(e, n, t);
});
var Jb = (e) => Je(1).withValue(() => q(e())).innerJoin();
var lo = (e) => e < 0.5 ? 1 : 1 - (e - 0.5) / 0.5;
var ll = (e, t, n) => {
  t = q(t), e = q(e), n = q(n);
...
var eM = (e, t, n) => (e = q(e), t = q(t), n = q(n), e.innerBind((r) => t.innerBind((i) => n.innerBind((s) => Wu(r, i, s)))));
function Yi(e) {
...
var { s: hl, sound: pl } = w(["s", "n", "gain"], "sound");
var { source: dl, src: ml } = w("source", "src");
var { n: gl } = w("n");
var { note: yl } = w(["note", "n"]);
var { accelerate: Al } = w("accelerate");
var { velocity: bl } = w("velocity");
var { gain: Ml } = w("gain");
var { postgain: Cl } = w("postgain");
var { amp: vl } = w("amp");
var { attack: Pl, att: Dl } = w("attack", "att");
var { fmh: Fl } = w(["fmh", "fmi"], "fmh");
var { fmi: El, fm: xl } = w(["fmi", "fmh"], "fm");
var { fmenv: wl } = w("fmenv");
var { fmattack: Sl } = w("fmattack");
var { fmwave: Bl } = w("fmwave");
var { fmdecay: _l } = w("fmdecay");
var { fmsustain: kl } = w("fmsustain");
var { fmrelease: Vl } = w("fmrelease");
var { fmvelocity: Il } = w("fmvelocity");
var { bank: Tl } = w("bank");
var { analyze: Nl } = w("analyze");
var { fft: Ll } = w("fft");
var { decay: Rl, dec: Gl } = w("decay", "dec");
var { sustain: Zl, sus: Xl } = w("sustain", "sus");
var { release: Wl, rel: Ol } = w("release", "rel");
var { hold: zl } = w("hold");
var { bandf: jl, bpf: $l, bp: ql } = w(["bandf", "bandq", "bpenv"], "bpf", "bp");
var { bandq: Hl, bpq: Kl } = w("bandq", "bpq");
var { begin: Yl } = w("begin");
var { end: Jl } = w("end");
var { loop: Ul } = w("loop");
var { loopBegin: Ql, loopb: e0 } = w("loopBegin", "loopb");
var { loopEnd: t0, loope: n0 } = w("loopEnd", "loope");
var { crush: r0 } = w("crush");
var { coarse: i0 } = w("coarse");
var { tremolo: s0 } = w(["tremolo", "tremolodepth", "tremoloskew", "tremolophase"], "trem");
var { tremolosync: u0 } = w(
  ["tremolosync", "tremolodepth", "tremoloskew", "tremolophase"],
  "tremsync"
);
var { tremolodepth: a0 } = w("tremolodepth", "tremdepth");
var { tremoloskew: o0 } = w("tremoloskew", "tremskew");
var { tremolophase: c0 } = w("tremolophase", "tremphase");
var { tremoloshape: l0 } = w("tremoloshape", "tremshape");
var { duck: f0 } = w("duckorbit", "duck");
var { duckdepth: h0 } = w("duckdepth");
var { duckattack: p0 } = w("duckattack", "duckatt");
var { drive: d0 } = w("drive");
var { byteBeatExpression: m0, bbexpr: g0 } = w("byteBeatExpression", "bbexpr");
var { byteBeatStartTime: y0, bbst: A0 } = w("byteBeatStartTime", "bbst");
var { channels: b0, ch: M0 } = w("channels", "ch");
var { pw: C0 } = w(["pw", "pwrate", "pwsweep"]);
var { pwrate: v0 } = w("pwrate");
var { pwsweep: P0 } = w("pwsweep");
var { phaserrate: D0, ph: F0, phaser: E0 } = w(
  ["phaserrate", "phaserdepth", "phasercenter", "phasersweep"],
  "ph",
  "phaser"
);
var { phasersweep: x0, phs: w0 } = w("phasersweep", "phs");
var { phasercenter: S0, phc: B0 } = w("phasercenter", "phc");
var { phaserdepth: _0, phd: k0, phasdp: V0 } = w("phaserdepth", "phd", "phasdp");
var { channel: I0 } = w("channel");
var { cut: T0 } = w("cut");
var { cutoff: N0, ctf: L0, lpf: R0, lp: G0 } = w(["cutoff", "resonance", "lpenv"], "ctf", "lpf", "lp");
var { lpenv: Z0, lpe: X0 } = w("lpenv", "lpe");
var { hpenv: W0, hpe: O0 } = w("hpenv", "hpe");
var { bpenv: z0, bpe: j0 } = w("bpenv", "bpe");
var { lpattack: $0, lpa: q0 } = w("lpattack", "lpa");
var { hpattack: H0, hpa: K0 } = w("hpattack", "hpa");
var { bpattack: Y0, bpa: J0 } = w("bpattack", "bpa");
var { lpdecay: U0, lpd: Q0 } = w("lpdecay", "lpd");
var { hpdecay: ef, hpd: tf } = w("hpdecay", "hpd");
var { bpdecay: nf, bpd: rf } = w("bpdecay", "bpd");
var { lpsustain: sf, lps: uf } = w("lpsustain", "lps");
var { hpsustain: af, hps: of } = w("hpsustain", "hps");
var { bpsustain: cf, bps: lf } = w("bpsustain", "bps");
var { lprelease: ff, lpr: hf } = w("lprelease", "lpr");
var { hprelease: pf, hpr: df } = w("hprelease", "hpr");
var { bprelease: mf, bpr: gf } = w("bprelease", "bpr");
var { ftype: yf } = w("ftype");
var { fanchor: Af } = w("fanchor");
var { vib: bf, vibrato: Mf, v: Cf } = w(["vib", "vibmod"], "vibrato", "v");
var { noise: vf } = w("noise");
var { vibmod: Pf, vmod: Df } = w(["vibmod", "vib"], "vmod");
var { hcutoff: Ff, hpf: Ef, hp: xf } = w(["hcutoff", "hresonance", "hpenv"], "hpf", "hp");
var { hresonance: wf, hpq: Sf } = w("hresonance", "hpq");
var { resonance: Bf, lpq: _f } = w("resonance", "lpq");
var { djf: kf } = w("djf");
var { delay: Vf } = w(["delay", "delaytime", "delayfeedback"]);
var { delayfeedback: If, delayfb: Tf, dfb: Nf } = w("delayfeedback", "delayfb", "dfb");
var { delaytime: Lf, delayt: Rf, dt: Gf } = w("delaytime", "delayt", "dt");
var { delaysync: Zf } = w("delaysync");
var { lock: Xf } = w("lock");
var { detune: Wf, det: Of } = w("detune", "det");
var { unison: zf } = w("unison");
var { spread: jf } = w("spread");
var { dry: $f } = w("dry");
var { fadeTime: qf, fadeOutTime: Hf } = w("fadeTime", "fadeOutTime");
var { fadeInTime: Kf } = w("fadeInTime");
var { freq: Yf } = w("freq");
var { pattack: Jf, patt: Uf } = w("pattack", "patt");
var { pdecay: Qf, pdec: eh } = w("pdecay", "pdec");
var { psustain: th, psus: nh } = w("psustain", "psus");
var { prelease: rh, prel: ih } = w("prelease", "prel");
var { penv: sh } = w("penv");
var { pcurve: uh } = w("pcurve");
var { panchor: ah } = w("panchor");
var { gate: oh, gat: ch } = w("gate", "gat");
var { leslie: lh } = w("leslie");
var { lrate: fh } = w("lrate");
var { lsize: hh } = w("lsize");
var { activeLabel: ph } = w("activeLabel");
var { label: dh } = w(["label", "activeLabel"]);
var { degree: mh } = w("degree");
var { mtranspose: gh } = w("mtranspose");
var { ctranspose: yh } = w("ctranspose");
var { harmonic: Ah } = w("harmonic");
var { stepsPerOctave: bh } = w("stepsPerOctave");
var { octaveR: Mh } = w("octaveR");
var { nudge: Ch } = w("nudge");
var { octave: vh } = w("octave");
var { orbit: Ph } = w("orbit");
var { overgain: Dh } = w("overgain");
var { overshape: Fh } = w("overshape");
var { pan: Eh } = w("pan");
var { panspan: xh } = w("panspan");
var { pansplay: wh } = w("pansplay");
var { panwidth: Sh } = w("panwidth");
var { panorient: Bh } = w("panorient");
var { rate: _h } = w("rate");
var { slide: kh } = w("slide");
var { semitone: Vh } = w("semitone");
var { voice: Ih } = w("voice");
var { chord: Th } = w("chord");
var { dictionary: Nh, dict: Lh } = w("dictionary", "dict");
var { anchor: Rh } = w("anchor");
var { offset: Gh } = w("offset");
var { octaves: Zh } = w("octaves");
var { mode: Xh } = w(["mode", "anchor"]);
var { room: Wh } = w(["room", "size"]);
var { roomlp: Oh, rlp: zh } = w("roomlp", "rlp");
var { roomdim: jh, rdim: $h } = w("roomdim", "rdim");
var { roomfade: qh, rfade: Hh } = w("roomfade", "rfade");
var { ir: Kh, iresponse: Yh } = w(["ir", "i"], "iresponse");
var { irspeed: Jh } = w("irspeed");
var { irbegin: Uh } = w("irbegin");
var { roomsize: Qh, size: e1, sz: t1, rsize: n1 } = w("roomsize", "size", "sz", "rsize");
var { shape: r1 } = w(["shape", "shapevol"]);
var { distort: i1, dist: s1 } = w(["distort", "distortvol"], "dist");
var { compressor: u1 } = w([
  "compressor",
  "compressorRatio",
  "compressorKnee",
...
var { compressorKnee: a1 } = w("compressorKnee");
var { compressorRatio: o1 } = w("compressorRatio");
var { compressorAttack: c1 } = w("compressorAttack");
var { compressorRelease: l1 } = w("compressorRelease");
var { speed: Ou } = w("speed");
var { stretch: f1 } = w("stretch");
var { unit: h1 } = w("unit");
var { squiz: p1 } = w("squiz");
var { vowel: d1 } = w("vowel");
var { waveloss: m1 } = w("waveloss");
var { density: tM } = w("density");
var { expression: g1 } = w("expression");
var { sustainpedal: y1 } = w("sustainpedal");
var { fshift: A1 } = w("fshift");
var { fshiftnote: b1 } = w("fshiftnote");
var { fshiftphase: M1 } = w("fshiftphase");
var { triode: C1 } = w("triode");
var { krush: v1 } = w("krush");
var { kcutoff: P1 } = w("kcutoff");
var { octer: D1 } = w("octer");
var { octersub: F1 } = w("octersub");
var { octersubsub: E1 } = w("octersubsub");
var { ring: x1 } = w("ring");
var { ringf: w1 } = w("ringf");
var { ringdf: S1 } = w("ringdf");
var { freeze: B1 } = w("freeze");
var { xsdelay: _1 } = w("xsdelay");
var { tsdelay: k1 } = w("tsdelay");
var { real: V1 } = w("real");
var { imag: I1 } = w("imag");
var { enhance: T1 } = w("enhance");
var { partials: N1 } = w("partials");
var { comb: L1 } = w("comb");
var { smear: R1 } = w("smear");
var { scram: G1 } = w("scram");
var { binshift: Z1 } = w("binshift");
var { hbrick: X1 } = w("hbrick");
var { lbrick: W1 } = w("lbrick");
var { frameRate: O1 } = w("frameRate");
var { frames: z1 } = w("frames");
var { hours: j1 } = w("hours");
var { minutes: $1 } = w("minutes");
var { seconds: q1 } = w("seconds");
var { songPtr: H1 } = w("songPtr");
var { uid: K1 } = w("uid");
var { val: Y1 } = w("val");
var { cps: J1 } = w("cps");
var { clip: U1, legato: Q1 } = w("clip", "legato");
var { duration: ep, dur: tp } = w("duration", "dur");
var { zrand: np } = w("zrand");
var { curve: rp } = w("curve");
var { deltaSlide: ip } = w("deltaSlide");
var { pitchJump: sp } = w("pitchJump");
var { pitchJumpTime: up } = w("pitchJumpTime");
var { lfo: ap, repeatTime: op } = w("lfo", "repeatTime");
var { znoise: cp } = w("znoise");
var { zmod: lp } = w("zmod");
var { zcrush: fp } = w("zcrush");
var { zdelay: hp } = w("zdelay");
var { zzfx: pp } = w("zzfx");
var { color: dp, colour: mp } = w(["color", "colour"]);
var zu = (...e) => e.reduce((t, n) => Object.assign(t, { [n]: Yi(n) }), {});
var gp = N("adsr", (e, t) => {
...
var { midichan: Mp } = w("midichan");
var { midimap: Cp } = w("midimap");
var { midiport: vp } = w("midiport");
var { midicmd: Pp } = w("midicmd");
var Dp = N("control", (e, t) => {
  if (!Array.isArray(e))
...
var { ccn: Fp } = w("ccn");
var { ccv: Ep } = w("ccv");
var { ctlNum: xp } = w("ctlNum");
var { nrpnn: wp } = w("nrpnn");
var { nrpv: Sp } = w("nrpv");
var { progNum: Bp } = w("progNum");
var _p = N("sysex", (e, t) => {
  if (!Array.isArray(e))
...
var { sysexid: kp } = w("sysexid");
var { sysexdata: Vp } = w("sysexdata");
var { midibend: Ip } = w("midibend");
var { miditouch: Tp } = w("miditouch");
var { polyTouch: Np } = w("polyTouch");
var ju = (e) => ni.has(e) ? ni.get(e) : e;
var Lp = N("as", (e, t) => (e = Array.isArray(e) ? e : [e], t.fmap((n) => (n = Array.isArray(n) ? n : [n], n = Object.fromEntries(e.map((r, i) => [ju(r), n[i]])), n))));
var Rp = N(
  "scrub",
  (e, t) => e.outerBind((n) => {
    Array.isArray(n) || (n = [n]);
...
var sM = N("euclid", function(e, t, n) {
  return n.struct(Ji(e, t, 0));
});
var uM = N("e", function(e, t) {
  Array.isArray(e) || (e = [e]);
  const [n, r = n, i = 0] = e;
  return t.struct(Ji(n, r, i));
});
var { euclidrot: aM, euclidRot: oM } = N(["euclidrot", "euclidRot"], function(e, t, n, r) {
  return r.struct(Ji(e, t, n));
});
var Zp = function(e, t, n, r) {
  if (e < 1)
    return Se;
  const s = Ji(e, t, 0).join("").split("1").slice(1).map((u) => [u.length + 1, true]);
  return r.struct(Xu(...s)).late(j(n).div(t));
};
var cM = N(["euclidLegato"], function(e, t, n) {
  return Zp(e, t, 0, n);
});
var lM = N(["euclidLegatoRot"], function(e, t, n, r) {
  return Zp(e, t, n, r);
});
var { euclidish: fM, eish: hM } = N(["euclidish", "eish"], function(e, t, n, r) {
  const i = Wu($u(e, t), new Array(e).fill(1), n);
  return r.struct(i).setSteps(t);
});
function Xp(e, t, n = 0.05, r = 0.1, i = 0.1, s = globalThis.setInterval, u = globalThis.clearInterval, a = true) {
...
var Ui = Vt((e) => 1 - e % 1);
var Hu = Ui.toBipolar();
var Ku = Vt((e) => Math.sin(Math.PI * 2 * e));
var Wp = Ku.fromBipolar();
var dM = Wp._early(j(1).div(4));
var mM = Ku._early(j(1).div(4));
var Op = Vt((e) => Math.floor(e * 2 % 2));
var gM = Op.toBipolar();
var yM = ot(li, Ui);
var AM = ot(qu, Hu);
var bM = ot(Ui, li);
...
var FM = (e) => e - Math.trunc(e);
var jp = (e) => zp(Math.trunc(FM(e / 300) * 536870912));
var $p = (e) => e % 536870912 / 536870912;
var ri = (e) => Math.abs($p(jp(e)));
var EM = (e, t) => {
  const n = [];
  for (let r = 0; r < t; ++r)
    n.push($p(e)), e = zp(e);
...
var xM = (e, t) => EM(jp(e), t);
var qp = (e) => li.range(0, e).round().segment(e);
var wM = (e) => {
...
var SM = N("shuffle", (e, t) => Yp(Kp(e), e, t));
var BM = N("scramble", (e, t) => Yp(ea(e)._segment(e), e, t));
var ht = Vt(ri);
var _M = ht.toBipolar();
var Qu = (e) => ht.fmap((t) => t < e);
var kM = (e) => q(e).fmap(Qu).innerJoin();
var VM = Qu(0.5);
var ea = (e) => ht.fmap((t) => Math.trunc(t * e));
var IM = (e) => q(e).fmap(ea).innerJoin();
var ta = (e, t) => (t = t.map(q), t.length == 0 ? Se : e.range(0, t.length).fmap((n) => {
  const r = Math.min(Math.max(Math.floor(n), 0), t.length - 1);
  return t[r];
}));
var Qi = (e, t) => ta(e, t).outerJoin();
var es = (e, t) => ta(e, t).innerJoin();
var Jp = (...e) => Qi(ht, e);
var TM = (...e) => es(ht, e);
var NM = Jp;
...
var RM = (...e) => Qp(...e).outerJoin();
var GM = (...e) => RM(ht, ...e);
var ed = (...e) => Qp(ht.segment(1), ...e).innerJoin();
var ZM = ed;
function XM(e) {
  let t = Math.floor(e), n = t + 1;
  const r = (u) => 6 * u ** 5 - 15 * u ** 4 + 10 * u ** 3;
  return (/* @__PURE__ */ ((u) => (a) => (o) => a + r(u) * (o - a))(e - t))(ri(t))(ri(n));
}
var td = (e) => e.fmap(XM);
function WM(e) {
...
var nd = (e) => e.fmap(WM);
var OM = td(Yu.fmap((e) => Number(e)));
var zM = nd(Yu.fmap((e) => Number(e)));
var jM = N(
  "degradeByWith",
...
var qM = N("degrade", (e) => e._degradeBy(0.5), true, true);
var HM = N(
  "undegradeBy",
  function(e, t) {
...
var KM = N("undegrade", (e) => e._undegradeBy(0.5), true, true);
var YM = N("sometimesBy", function(e, t, n) {
  return q(e).fmap((r) => Le(n._degradeBy(r), t(n._undegradeBy(1 - r)))).innerJoin();
});
var JM = N("sometimes", function(e, t) {
  return t._sometimesBy(0.5, e);
});
var UM = N("someCyclesBy", function(e, t, n) {
  return q(e).fmap(
    (r) => Le(
...
var QM = N("someCycles", function(e, t) {
  return t._someCyclesBy(0.5, e);
});
var eC = N("often", function(e, t) {
  return t.sometimesBy(0.75, e);
});
var tC = N("rarely", function(e, t) {
  return t.sometimesBy(0.25, e);
});
var nC = N("almostNever", function(e, t) {
  return t.sometimesBy(0.1, e);
});
var rC = N("almostAlways", function(e, t) {
  return t.sometimesBy(0.9, e);
});
var iC = N("never", function(e, t) {
  return t;
});
var sC = N("always", function(e, t) {
  return e(t);
});
function na(e) {
...
var uC = N("whenKey", function(e, t, n) {
  return n.when(na(e), t);
});
var aC = N("keyDown", function(e) {
  return e.fmap(na);
});
var an = function(e, t, n = true) {
...
var oC = N("pick", function(e, t) {
  return an(e, t, false).innerJoin();
});
var id = N("pickmod", function(e, t) {
  return an(e, t, true).innerJoin();
});
var cC = N("pickF", function(e, t, n) {
  return n.apply(rd(e, t));
});
var lC = N("pickmodF", function(e, t, n) {
  return n.apply(id(e, t));
});
var fC = N("pickOut", function(e, t) {
  return an(e, t, false).outerJoin();
});
var hC = N("pickmodOut", function(e, t) {
  return an(e, t, true).outerJoin();
});
var pC = N("pickRestart", function(e, t) {
  return an(e, t, false).restartJoin();
});
var dC = N("pickmodRestart", function(e, t) {
  return an(e, t, true).restartJoin();
});
var mC = N("pickReset", function(e, t) {
  return an(e, t, false).resetJoin();
});
var gC = N("pickmodReset", function(e, t) {
  return an(e, t, true).resetJoin();
});
var { inhabit: yC, pickSqueeze: AC } = N(["inhabit", "pickSqueeze"], function(e, t) {
  return an(e, t, false).squeezeJoin();
});
var { inhabitmod: bC, pickmodSqueeze: MC } = N(["inhabitmod", "pickmodSqueeze"], function(e, t) {
  return an(e, t, true).squeezeJoin();
});
var CC = (e, t) => (t = t.map(q), t.length == 0 ? Se : e.fmap((n) => {
  const r = kt(Math.round(n), t.length);
  return t[r];
}).squeezeJoin());
var Ii;
try {
  Ii = window == null ? void 0 : window.speechSynthesis;
} catch {
  console.warn("cannot use window: not in browser?");
}
var fo = Ii == null ? void 0 : Ii.getVoices();
function vC(e, t, n) {
  Ii.cancel();
...
function DC(e, t = {}) {
  const { wrapExpression: n = true, wrapAsync: r = true } = t;
  n && (e = `{${e}}`), r && (e = `(async ()=>${e})()`);
...
var FC = class {
  constructor({ onTrigger: t, onToggle: n, getTime: r }) {
    this.started = false, this.cps = 0.5, this.getTime = r, this.time_at_last_tick_message = 0, this.collator = new Tc({ getTargetClockTime: r }), this.onToggle = n, this.latency = 0.1, this.cycle = 0, this.id = Math.round(Date.now() * Math.random()), this.worker = new SharedWorker(new URL(
      /* @vite-ignore */
    ...
    const i = (u) => {
      ...
      this.pattern.queryArc(u, a, { _cps: this.cps }).forEach((h) => {
        if (h.hasOnset()) {
          ...
          t == null ? void 0 : t(h, 0, A, this.cps, p);
        }
      });
    };
  ...
  start() {
    Ue("[cyclist] start"), this.setStarted(true);
  }
  stop() {
    Ue("[cyclist] stop"), this.collator.reset(), this.setStarted(false);
  }
...
var ad = class {
  constructor({
    ...
    this.started = false, this.beforeStart = f, this.cps = 0.5, this.num_ticks_since_cps_change = 0, this.lastTick = 0, this.lastBegin = 0, this.lastEnd = 0, this.getTime = s, this.num_cycles_at_cps_change = 0, this.seconds_at_cps_change, this.onToggle = r, this.latency = u, this.clock = Xp(
      s,
        ...
        try {
          ...
          this.pattern.queryArc(F, _, { _cps: this.cps }).forEach((L) => {
            if (L.hasOnset()) {
              ...
              n == null ? void 0 : n(L, B, x, this.cps, S), L.value.cps !== void 0 && this.cps != L.value.cps && (this.cps = L.value.cps, this.num_ticks_since_cps_change = 0);
            }
          });
        } catch (F) {
          Su(F), i == null ? void 0 : i(F);
        }
      },
      t,
  ...
  async start() {
    ...
    Ue("[cyclist] start"), this.clock.start(), this.setStarted(true);
  }
  pause() {
    Ue("[cyclist] pause"), this.clock.pause(), this.setStarted(false);
  }
  stop() {
    Ue("[cyclist] stop"), this.clock.stop(), this.lastEnd = 0, this.setStarted(false);
  }
...
function EC({
  ...
  const C = {
    ...
    Object.assign(C, oe), C.isDirty = C.code !== C.activeCode, C.error = C.evalError || C.schedulerError, f == null ? void 0 : f(C);
  }, k = {
    onTrigger: od({ defaultOutput: e, getTime: s }),
    getTime: s,
    onToggle: (oe) => {
      _({ started: oe }), a == null ? void 0 : a(oe);
    },
    setInterval: m,
    clearInterval: p,
    beforeStart: r
  ...
  }, T = async (oe, W = true) => (oe = (o == null ? void 0 : o(oe)) || oe, await L.setPattern(oe, W), oe);
  Ni(() => L.now());
  ...
  return { scheduler: L, evaluate: async (oe, W = true, $e = true) => {
    if (!oe)
      throw new Error("no code to evaluate");
    try {
      _({ code: oe, pending: true }), await ie(), Ni(() => L.now()), await (n == null ? void 0 : n({ code: oe })), me = [], $e && V(), M && (oe = `mondolang\`${oe}\``);
      ...
      return Ue("[eval] code updated"), xe = await T(xe, W), _({
        miniLocations: (tt == null ? void 0 : tt.miniLocations) || [],
        widgets: (tt == null ? void 0 : tt.widgets) || [],
        activeCode: oe,
        pattern: xe,
        evalError: void 0,
        schedulerError: void 0,
        pending: false
      }), i == null ? void 0 : i({ code: oe, pattern: xe, meta: tt }), xe;
    } catch (xe) {
      Ue(`[eval] error: ${xe.message}`, "error"), console.error(xe), _({ evalError: xe, pending: false }), t == null ? void 0 : t(xe);
    }
  }, start: X, stop: H, pause: U, setCps: z, setPattern: T, setCode: (oe) => _({ code: oe }), toggle: O, state: C };
}
var od = ({ getTime: e, defaultOutput: t }) => async (n, r, i, s, u) => {
  try {
...
var VC = { c: 0, d: 2, e: 4, f: 5, g: 7, a: 9, b: 11 };
var IC = { "#": 1, b: -1, s: 1, f: -1 };
var ts = (e, t = 3) => {
  const [n, r, i = t] = kC(e);
  if (!n)
    throw new Error('not a note: "' + e + '"');
  const s = VC[n.toLowerCase()], u = (r == null ? void 0 : r.split("").reduce((a, o) => a + IC[o], 0)) || 0;
  return (Number(i) + 1) * 12 + s + u;
};
var hd = (e) => Math.pow(2, (e - 69) / 12) * 440;
var Kn = (e, t, n) => Math.min(Math.max(e, t), n);
var TC = (e) => 12 * Math.log(e / 440) / Math.LN2 + 69;
var NC = (e, t) => {
  if (typeof e != "object")
    throw new Error("valueToMidi: expected object value");
  let { freq: n, note: r } = e;
...
var pd = (e, t) => (e % t + t) % t;
var ho = (e, t) => pd(Math.round(Mn(e, 0)), t);
function LC(e, t) {
  return e / t;
}
...
function pu(e = "white", t, n = 0.02) {
  ...
  return i.buffer = dd(e, n), i.loop = true, i.start(t), {
    node: i,
    stop: (s) => i.stop(s)
  };
}
function GC(e, t, n) {
  ...
  return {
    node: gd(e, r.node, t),
    stop: (s) => r == null ? void 0 : r.stop(s)
  };
}
var sa = ["pink", "white", "brown", "crackle"];
function gt(e) {
  const t = Pe().createGain();
  return t.gain.value = e, t;
}
var mo = (e, t, n, r) => r - n === 0 ? 0 : (t - e) / (r - n);
function Ot(e, t, n, r) {
...
var en = (e, t, n, r, i, s, u, a, o, f = "exponential") => {
...
var ZC = ["linear", "exponential"];
function ii(e, t, n, r) {
  if (!(t.pattack ?? t.pdecay ?? t.psustain ?? t.prelease ?? t.penv))
    return;
  const s = Mn(t.penv, 1, true), u = ZC[t.pcurve ?? 0];
  let [a, o, f, h] = tn(
...
var XC = (e, t = 1, n = "sine") => {
  const r = Pe();
  let i;
  sa.includes(n) ? (i = r.createBufferSource(), i.buffer = dd(n, 2), i.loop = true) : (i = r.createOscillator(), i.type = n, i.frequency.value = e), i.start();
...
var bd = async (e, t, n) => {
  ...
  (a.startsWith("wt_") ? 1 : e.loop) && (u.loop = true, u.loopStart = o * u.buffer.duration - p, u.loopEnd = f * u.buffer.duration - p);
...
var Pd = (e, t, n = e._base || "") => Object.entries(e).forEach(([r, i]) => {
...
async function Ed(e, t, n, r, i) {
  ...
  T.connect(X), k.onended = function() {
    k.disconnect(), x == null ? void 0 : x.stop(), T.disconnect(), X.disconnect(), n();
  };
  let U = H + _ + 0.01;
  k.stop(U);
...
var ca = new Map(Object.entries(fi));
function la(e, t) {
  ca.set(e, t);
}
function Ye(e) {
...
function cv(e, t, n, r) {
  ...
  if (n = Kn(n, 0, 0.98), !we[e].delayNode) {
    ...
    (_a2 = s.start) == null ? void 0 : _a2.call(s, r), Zi(s, e), we[e].delayNode = s;
  }
...
function rs(e = "time", t = 1) {
  const n = {
    time: () => {
      var _a2;
      return (_a2 = ft[t]) == null ? void 0 : _a2.getFloatTimeDomainData(zn[t]);
    },
    frequency: () => {
      var _a2;
      return (_a2 = ft[t]) == null ? void 0 : _a2.getFloatFrequencyData(zn[t]);
    }
  }[e];
  if (!n)
...
var fa = async (e, t, n, r = 0.5, i = 0.5) => {
  var _a2, _b2, _c2;
  const s = Pe();
  let { stretch: u } = e;
  ...
  for (let ye = 0; ye <= Gr.size - xd; ye++) {
    ...
    (_b2 = (_a2 = Ne == null ? void 0 : Ne.node) == null ? void 0 : _a2.gain) == null ? void 0 : _b2.linearRampToValueAtTime(0, Ai), (_c2 = Ne == null ? void 0 : Ne.stop) == null ? void 0 : _c2.call(Ne, Ai), Gr.delete(Ct);
  }
  let I = [];
  if (["-", "~", "_"].includes(A))
    return;
  ...
  if (C)
    ...
    const { onTrigger: ye } = Si(A), Ne = await ye(t, e, () => {
      I.forEach((Ct) => Ct == null ? void 0 : Ct.disconnect()), Gr.delete(P);
    });
...
function Fi(e) {
  var _a2;
  e != null && (e.disconnect(), (_a2 = e.parameters.get("end")) == null ? void 0 : _a2.setValueAtTime(0, 0));
}
var yv = ["triangle", "square", "sawtooth", "sine"];
var Av = [
  ["tri", "triangle"],
  ["sqr", "square"],
  ["saw", "sawtooth"],
  ...
  [...yv].forEach((e) => {
    ...
    (e, t, n) => {
      ...
      let V = Yr(
        r,
        () => {
          Fi(k), B.disconnect(), n(), x == null ? void 0 : x.stop(), S == null ? void 0 : S.stop();
        },
        e,
        C
      );
    ...
    (e, t, n) => {
      ...
      let S = Yr(
        r,
        () => {
          Fi(C), Fi(L), k.disconnect(), n(), _ == null ? void 0 : _.stop(), F == null ? void 0 : F.stop();
        },
        e,
        M
      );
...
function Wd(e, t, n) {
  ...
  let f;
  return s && (f = GC(u, s, t)), {
    node: (f == null ? void 0 : f.node) || u,
    stop: (h) => {
      o.stop(h), a == null ? void 0 : a.stop(h), f == null ? void 0 : f.stop(h), u.stop(h);
    },
    triggerRelease: (h) => {
    }
  };
...
function Mv(e = 1, t = 0.05, n = 220, r = 0, i = 0, s = 0.1, u = 0, a = 1, o = 0, f = 0, h = 0, m = 0, p = 0, A = 0, M = 0, C = 0, F = 0, _ = 1, k = 0, L = 0) {
  ...
  for (r = r * x + 9, k *= x, i *= x, s *= x, F *= x, f *= 500 * S / x ** 3, M *= S / x, h *= S / x, m *= x, p = p * x | 0, ie = r + k + i + s + F | 0; O < ie; H[O++] = pe)
    ...
    Math.cos(M * U++), X += le - le * A * (1 - (Math.sin(O) + 1) * 1e9 % 2), z && ++z > m && (n += h, T += h, z = 0), p && !(++te % p) && (n = T, o = V, z || (z = 1));
  return H;
}
var Od = (e, t) => {
  let {
...
var jd = () => {
  var _a2;
  mr && (mr == null ? void 0 : mr.stop(), (_a2 = mr == null ? void 0 : mr.node) == null ? void 0 : _a2.disconnect());
};
typeof window < "u" && window.addEventListener("message", (e) => {
  var _a2;
  e.data === "strudel-stop" ? jd() : ((_a2 = e.data) == null ? void 0 : _a2.dough) && (mr == null ? void 0 : mr.node.port.postMessage(e.data));
});
var vv = async (e) => {
  const t = Pe();
...
var { Pattern: Pv, logger: Dv, repl: Fv } = cd;
fd(Dv);
var Ev = (e) => (e.ensureObjectValue(), e.value);
var qd = (e, t, n, r, i) => {
  var _a2;
  return fa(Ev(e), i, n, r, (_a2 = e.whole) == null ? void 0 : _a2.begin.valueOf());
};
function Hd(e = {}) {
  return e = {
...
var Qn = (e = "test-canvas", t) => {
  let { contextType: n = "2d", pixelated: r = false, pixelRatio: i = window.devicePixelRatio } = {}, s = document.querySelector("#" + e);
  if (!s) {
  ...
  return s.getContext(n, { willReadFrequently: true });
};
var Jr = {};
function xv(e) {
...
var bo = "#22222210";
$.prototype.animate = function({ callback: e, sync: t = false, smear: n = 0.5 } = {}) {
...
var { x: Kd, y: gE, w: yE, h: AE, angle: bE, r: ME, fill: CE, smear: vE } = zu("x", "y", "w", "h", "angle", "r", "fill", "smear");
...
$.prototype.pianoroll = function(e = {}) {
  let { cycles: t = 4, playhead: n = 0.5, overscan: r = 0, hideNegative: i = false, ctx: s = Qn(), id: u = 1 } = e, a = -t * n, o = t * (1 - n);
...
function Yd({
  ...
  M && (p = xe, A = tt, oe = A - p + 1), $e = ge.sort(
    ...
    if (V && !Ke)
      return;
    let Ve = (_a2 = Ee.value) == null ? void 0 : _a2.color;
...
var Bv = (e = {}) => (t, n, r, i) => Yd({ ctx: t, time: n, haps: r, ...Sv(i, e) });
...
var Co = (e, t, n, r, i = 0) => _v((e + i) * 360, t * e, n, r);
function vo(e) {
  let {
    ctx: t,
    from: n = 0,
...
function kv(e) {
  ...
  _.forEach((O) => {
    var _a2;
    const z = O.whole.begin <= F && O.endClipped > F, te = O.whole.begin - F + s, me = O.endClipped - F + s - f, pe = ((_a2 = O.value) == null ? void 0 : _a2.color) || m, le = A || z ? pe : p, ie = M ? 1 - Math.abs((O.whole.begin - F) / X) : 1;
    vo({
      ctx: C,
      ...T,
      from: te,
...
var Do = (e, t) => 0.5 - Math.log2(e / t) % 1;
function Iv({
  haps: e,
  ctx: t,
  id: n,
...
$.prototype.tscope = function(e = {}) {
  ...
  return this.analyze(t).draw(
    (n) => {
      var _a2, _b2;
      e.color = ((_b2 = (_a2 = n[0]) == null ? void 0 : _a2.value) == null ? void 0 : _b2.color) || Cn().foreground, e.color, Qd(e.smear, "0,0,0", e.ctx), Jd(ft[t], e);
    },
    { id: t }
  );
};
...
$.prototype.spectrum = function(e = {}) {
  ...
  return this.analyze(t).draw(
    (n) => {
      var _a2, _b2;
      e.color = ((_b2 = (_a2 = n[0]) == null ? void 0 : _a2.value) == null ? void 0 : _b2.color) || Fo[t] || Cn().foreground, Fo[t] = e.color, Tv(ft[t], e);
    },
    { id: t }
  );
};
...
var Nv = Object.freeze(Object.defineProperty({
  __proto__: null,
...
var Gv = (e, t) => (n, r) => {
  var _a2;
  const u = (_a2 = e.source_[r].options_) == null ? void 0 : _a2.ops, a = n.__steps_source;
  if (u)
    for (const o of u)
      switch (o.type_) {
        case "stretch": {
    ...
    case "pattern": {
      ...
      switch (u) {
        ...
        default: {
          if (e.source_.some((h) => {
            var _a2;
            return !!((_a2 = h.options_) == null ? void 0 : _a2.weight);
          })) {
            const h = e.source_.reduce(
              (m, p) => {
                var _a2;
                return m.add(((_a2 = p.options_) == null ? void 0 : _a2.weight) || j(1));
              },
              j(0)
            );
            o = Xu(
              ...e.source_.map((m, p) => {
                var _a2;
                return [((_a2 = m.options_) == null ? void 0 : _a2.weight) || j(1), s[p]];
              })
      ...
      return a.length && (o.__steps_source = true), o;
    }
    case "element":
      return i(e.source_);
    case "atom": {
...
var ha = (e, t, n = 0) => {
  const { start: r, end: i } = t.location_, s = e == null ? void 0 : e.split("").slice(r.offset, i.offset).join(""), [u = 0, a = 0] = s ? s.split(t.source_).map((o) => o.split("").filter((f) => f === " ").length) : [];
...
var pa = (e, t = 0, n) => nm(e, t, n).map((r) => ha(e, r, t));
var da = (...e) => {
  const t = e.map((n) => {
    const r = `"${n}"`, i = hi(r);
    return Pr(i, r);
...
var jv = "‌‍·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛ࢗ-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ೳഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-໎໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-ᫎᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‌‍‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯・꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿･";
var sm = "ªµºÀ-ÖØ-öø-ˁˆ-ˑˠ-ˤˬˮͰ-ʹͶͷͺ-ͽͿΆΈ-ΊΌΎ-ΡΣ-ϵϷ-ҁҊ-ԯԱ-Ֆՙՠ-ֈא-תׯ-ײؠ-يٮٯٱ-ۓەۥۦۮۯۺ-ۼۿܐܒ-ܯݍ-ޥޱߊ-ߪߴߵߺࠀ-ࠕࠚࠤࠨࡀ-ࡘࡠ-ࡪࡰ-ࢇࢉ-ࢎࢠ-ࣉऄ-हऽॐक़-ॡॱ-ঀঅ-ঌএঐও-নপ-রলশ-হঽৎড়ঢ়য়-ৡৰৱৼਅ-ਊਏਐਓ-ਨਪ-ਰਲਲ਼ਵਸ਼ਸਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઍએ-ઑઓ-નપ-રલળવ-હઽૐૠૡૹଅ-ଌଏଐଓ-ନପ-ରଲଳଵ-ହଽଡ଼ଢ଼ୟ-ୡୱஃஅ-ஊஎ-ஐஒ-கஙசஜஞடணதந-பம-ஹௐఅ-ఌఎ-ఐఒ-నప-హఽౘ-ౚౝౠౡಀಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹಽೝೞೠೡೱೲഄ-ഌഎ-ഐഒ-ഺഽൎൔ-ൖൟ-ൡൺ-ൿඅ-ඖක-නඳ-රලව-ෆก-ะาำเ-ๆກຂຄຆ-ຊຌ-ຣລວ-ະາຳຽເ-ໄໆໜ-ໟༀཀ-ཇཉ-ཬྈ-ྌက-ဪဿၐ-ၕၚ-ၝၡၥၦၮ-ၰၵ-ႁႎႠ-ჅჇჍა-ჺჼ-ቈቊ-ቍቐ-ቖቘቚ-ቝበ-ኈኊ-ኍነ-ኰኲ-ኵኸ-ኾዀዂ-ዅወ-ዖዘ-ጐጒ-ጕጘ-ፚᎀ-ᎏᎠ-Ᏽᏸ-ᏽᐁ-ᙬᙯ-ᙿᚁ-ᚚᚠ-ᛪᛮ-ᛸᜀ-ᜑᜟ-ᜱᝀ-ᝑᝠ-ᝬᝮ-ᝰក-ឳៗៜᠠ-ᡸᢀ-ᢨᢪᢰ-ᣵᤀ-ᤞᥐ-ᥭᥰ-ᥴᦀ-ᦫᦰ-ᧉᨀ-ᨖᨠ-ᩔᪧᬅ-ᬳᭅ-ᭌᮃ-ᮠᮮᮯᮺ-ᯥᰀ-ᰣᱍ-ᱏᱚ-ᱽᲀ-ᲊᲐ-ᲺᲽ-Ჿᳩ-ᳬᳮ-ᳳᳵᳶᳺᴀ-ᶿḀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼⁱⁿₐ-ₜℂℇℊ-ℓℕ℘-ℝℤΩℨK-ℹℼ-ℿⅅ-ⅉⅎⅠ-ↈⰀ-ⳤⳫ-ⳮⳲⳳⴀ-ⴥⴧⴭⴰ-ⵧⵯⶀ-ⶖⶠ-ⶦⶨ-ⶮⶰ-ⶶⶸ-ⶾⷀ-ⷆⷈ-ⷎⷐ-ⷖⷘ-ⷞ々-〇〡-〩〱-〵〸-〼ぁ-ゖ゛-ゟァ-ヺー-ヿㄅ-ㄯㄱ-ㆎㆠ-ㆿㇰ-ㇿ㐀-䶿一-ꒌꓐ-ꓽꔀ-ꘌꘐ-ꘟꘪꘫꙀ-ꙮꙿ-ꚝꚠ-ꛯꜗ-ꜟꜢ-ꞈꞋ-ꟍꟐꟑꟓꟕ-Ƛꟲ-ꠁꠃ-ꠅꠇ-ꠊꠌ-ꠢꡀ-ꡳꢂ-ꢳꣲ-ꣷꣻꣽꣾꤊ-ꤥꤰ-ꥆꥠ-ꥼꦄ-ꦲꧏꧠ-ꧤꧦ-ꧯꧺ-ꧾꨀ-ꨨꩀ-ꩂꩄ-ꩋꩠ-ꩶꩺꩾ-ꪯꪱꪵꪶꪹ-ꪽꫀꫂꫛ-ꫝꫠ-ꫪꫲ-ꫴꬁ-ꬆꬉ-ꬎꬑ-ꬖꬠ-ꬦꬨ-ꬮꬰ-ꭚꭜ-ꭩꭰ-ꯢ가-힣ힰ-ퟆퟋ-ퟻ豈-舘並-龎ﬀ-ﬆﬓ-ﬗיִײַ-ﬨשׁ-זּטּ-לּמּנּסּףּפּצּ-ﮱﯓ-ﴽﵐ-ﶏﶒ-ﷇﷰ-ﷻﹰ-ﹴﹶ-ﻼＡ-Ｚａ-ｚｦ-ﾾￂ-ￇￊ-ￏￒ-ￗￚ-ￜ";
var Rs = {
...
var Gs = "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this";
var $v = {
  5: Gs,
...
var qv = /^in(stanceof)?$/;
var Hv = new RegExp("[" + sm + "]");
var Kv = new RegExp("[" + sm + jv + "]");
function gu(e, t) {
...
function vn(e, t) {
  return e < 65 ? e === 36 : e < 91 ? true : e < 97 ? e === 95 : e < 123 ? true : e <= 65535 ? e >= 170 && Hv.test(String.fromCharCode(e)) : t === false ? false : gu(e, im);
}
function yr(e, t) {
  return e < 48 ? e === 36 : e < 58 ? true : e < 65 ? false : e < 91 ? true : e < 97 ? e === 95 : e < 123 ? true : e <= 65535 ? e >= 170 && Kv.test(String.fromCharCode(e)) : t === false ? false : gu(e, im) || gu(e, zv);
}
var De = function(t, n) {
...
function wt(e, t) {
  return new De(e, { beforeExpr: true, binop: t });
}
var St = { beforeExpr: true };
var mt = { startsExpr: true };
var ma = {};
function ve(e, t) {
...
var b = {
  ...
  bracketL: new De("[", { beforeExpr: true, startsExpr: true }),
  bracketR: new De("]"),
  braceL: new De("{", { beforeExpr: true, startsExpr: true }),
  braceR: new De("}"),
  parenL: new De("(", { beforeExpr: true, startsExpr: true }),
  parenR: new De(")"),
  comma: new De(",", St),
  semi: new De(";", St),
  colon: new De(":", St),
  ...
  ellipsis: new De("...", St),
  backQuote: new De("`", mt),
  dollarBraceL: new De("${", { beforeExpr: true, startsExpr: true }),
  ...
  eq: new De("=", { beforeExpr: true, isAssign: true }),
  assign: new De("_=", { beforeExpr: true, isAssign: true }),
  incDec: new De("++/--", { prefix: true, postfix: true, startsExpr: true }),
  prefix: new De("!/~", { beforeExpr: true, prefix: true, startsExpr: true }),
  logicalOR: wt("||", 1),
  logicalAND: wt("&&", 2),
  bitwiseOR: wt("|", 3),
  bitwiseXOR: wt("^", 4),
  ...
  relational: wt("</>/<=/>=", 7),
  bitShift: wt("<</>>/>>>", 8),
  plusMin: new De("+/-", { beforeExpr: true, binop: 9, prefix: true, startsExpr: true }),
  modulo: wt("%", 10),
  star: wt("*", 10),
  slash: wt("/", 10),
  starstar: new De("**", { beforeExpr: true }),
  coalesce: wt("??", 1),
  // Keyword token types.
  _break: ve("break"),
  _case: ve("case", St),
...
var Jv = om.hasOwnProperty;
var Uv = om.toString;
var Fr = Object.hasOwn || function(e, t) {
  return Jv.call(e, t);
};
var Eo = Array.isArray || function(e) {
...
function eP(e) {
  ...
  if (t.ecmaVersion === "latest" ? t.ecmaVersion = 1e8 : t.ecmaVersion == null ? (!wo && typeof console == "object" && console.warn && (wo = true, console.warn(`Since Acorn 8.0.0, options.ecmaVersion is required.
...
var Qe = function(t, n, r) {
  ...
  var i = "";
  t.allowReserved !== true && (i = Rs[t.ecmaVersion >= 6 ? 6 : t.ecmaVersion === 5 ? 5 : 3], t.sourceType === "module" && (i += " await")), this.reservedWords = Vn(i);
  var s = (i ? i + " " : "") + Rs.strict;
  this.reservedWordsStrict = Vn(s), this.reservedWordsStrictBind = Vn(s + " " + Rs.strictBind), this.input = String(n), this.containsEsc = false, r ? (this.pos = r, this.lineStart = this.input.lastIndexOf(`
...
var on = { inFunction: { configurable: true }, inGenerator: { configurable: true }, inAsync: { configurable: true }, canAwait: { configurable: true }, allowSuper: { configurable: true }, allowDirectSuper: { configurable: true }, treatFunctionsAsVar: { configurable: true }, allowNewDotTarget: { configurable: true }, inClassStaticBlock: { configurable: true } };
...
ee.isLet = function(e) {
  ...
  if (r === 123 || r > 55295 && r < 56320)
    return true;
  if (vn(r, true)) {
    for (var i = n + 1; yr(r = this.input.charCodeAt(i), true); )
      ++i;
...
ee.parseForStatement = function(e) {
  ...
  if (this.type === b._var || this.type === b._const || n) {
    ...
    return this.next(), this.parseVar(r, true, i), this.finishNode(r, "VariableDeclaration"), (this.type === b._in || this.options.ecmaVersion >= 6 && this.isContextual("of")) && r.declarations.length === 1 ? (this.options.ecmaVersion >= 9 && (this.type === b._in ? t > -1 && this.unexpected(t) : e.await = t > -1), this.parseForIn(e, r)) : (t > -1 && this.unexpected(t), this.parseFor(e, r));
  }
  var s = this.isContextual("let"), u = false, a = this.containsEsc, o = new ss(), f = this.start, h = t > -1 ? this.parseExprSubscripts(o, "await") : this.parseExpression(true, o);
  return this.type === b._in || (u = this.options.ecmaVersion >= 6 && this.isContextual("of")) ? (t > -1 ? (this.type === b._in && this.unexpected(t), e.await = true) : u && this.options.ecmaVersion >= 8 && (h.start === f && !a && h.type === "Identifier" && h.name === "async" ? this.unexpected() : this.options.ecmaVersion >= 9 && (e.await = false)), s && u && this.raise(h.start, "The left-hand side of a for-of loop may not start with 'let'."), this.toAssignable(h, false, o), this.checkLValPattern(h), this.parseForIn(e, h)) : (this.checkExpressionErrors(o, true), t > -1 && this.unexpected(t), this.parseFor(e, h));
};
ee.parseFunctionStatement = function(e, t, n) {
  return this.next(), this.parseFunction(e, Ur | (n ? 0 : Au), false, t);
};
...
ee.parseSwitchStatement = function(e) {
  ...
  for (var t, n = false; this.type !== b.braceR; )
    if (this.type === b._case || this.type === b._default) {
      var r = this.type === b._case;
      t && this.finishNode(t, "SwitchCase"), e.cases.push(t = this.startNode()), t.consequent = [], this.next(), r ? t.test = this.parseExpression() : (n && this.raiseRecoverable(this.lastTokStart, "Multiple default clauses"), n = true, t.test = null), this.expect(b.colon);
    } else
...
ee.parseTryStatement = function(e) {
  if (this.next(), e.block = this.parseBlock(), e.handler = null, this.type === b._catch) {
    ...
    this.next(), this.eat(b.parenL) ? t.param = this.parseCatchClauseParam() : (this.options.ecmaVersion < 10 && this.unexpected(), t.param = null, this.enterScope(0)), t.body = this.parseBlock(false), this.exitScope(), e.handler = this.finishNode(t, "CatchClause");
  }
...
ee.parseBlock = function(e, t, n) {
  for (e === void 0 && (e = true), t === void 0 && (t = this.startNode()), t.body = [], this.expect(b.braceL), e && this.enterScope(0); this.type !== b.braceR; ) {
...
ee.parseVarId = function(e, t) {
  e.id = this.parseBindingAtom(), this.checkLValPattern(e.id, t === "var" ? Ma : Fn, false);
};
var Ur = 1;
var Au = 2;
var ym = 4;
ee.parseFunction = function(e, t, n, r, i) {
  ...
  return this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(ba(e.async, e.generator)), t & Ur || (e.id = this.type === b.name ? this.parseIdent() : null), this.parseFunctionParams(e), this.parseFunctionBody(e, n, false, i), this.yieldPos = s, this.awaitPos = u, this.awaitIdentPos = a, this.finishNode(e, t & Ur ? "FunctionDeclaration" : "FunctionExpression");
};
ee.parseFunctionParams = function(e) {
  this.expect(b.parenL), e.params = this.parseBindingList(b.parenR, false, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams();
};
ee.parseClass = function(e, t) {
  this.next();
  var n = this.strict;
  this.strict = true, this.parseClassId(e, t), this.parseClassSuper(e);
  var r = this.enterClassBody(), i = this.startNode(), s = false;
  for (i.body = [], this.expect(b.braceL); this.type !== b.braceR; ) {
    var u = this.parseClassElement(e.superClass !== null);
    u && (i.body.push(u), u.type === "MethodDefinition" && u.kind === "constructor" ? (s && this.raiseRecoverable(u.start, "Duplicate constructor in the same class"), s = true) : u.key && u.key.type === "PrivateIdentifier" && sP(r, u) && this.raiseRecoverable(u.key.start, "Identifier '#" + u.key.name + "' has already been declared"));
  }
...
ee.parseClassElement = function(e) {
  if (this.eat(b.semi))
    return null;
  var t = this.options.ecmaVersion, n = this.startNode(), r = "", i = false, s = false, u = "method", a = false;
  if (this.eatContextual("static")) {
    if (t >= 13 && this.eat(b.braceL))
      return this.parseClassStaticBlock(n), n;
    this.isClassElementNameStart() || this.type === b.star ? a = true : r = "static";
  }
  if (n.static = a, !r && t >= 8 && this.eatContextual("async") && ((this.isClassElementNameStart() || this.type === b.star) && !this.canInsertSemicolon() ? s = true : r = "async"), !r && (t >= 9 || !s) && this.eat(b.star) && (i = true), !r && !s && !i) {
    var o = this.value;
    (this.eatContextual("get") || this.eatContextual("set")) && (this.isClassElementNameStart() ? u = o : r = o);
  }
  if (r ? (n.computed = false, n.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), n.key.name = r, this.finishNode(n.key, "Identifier")) : this.parseClassElementName(n), t < 13 || this.type === b.parenL || u !== "method" || i || s) {
...
ee.parseClassElementName = function(e) {
  this.type === b.privateId ? (this.value === "constructor" && this.raise(this.start, "Classes can't have an element named '#constructor'"), e.computed = false, e.key = this.parsePrivateIdent()) : this.parsePropertyName(e);
};
...
ee.parseClassId = function(e, t) {
  this.type === b.name ? (e.id = this.parseIdent(), t && this.checkLValSimple(e.id, Fn, false)) : (t === true && this.unexpected(), e.id = null);
};
ee.parseClassSuper = function(e) {
  e.superClass = this.eat(b._extends) ? this.parseExprSubscripts(null, false) : null;
};
...
function sP(e, t) {
  ...
  return t.type === "MethodDefinition" && (t.kind === "get" || t.kind === "set") && (i = (t.static ? "s" : "i") + t.kind), r === "iget" && i === "iset" || r === "iset" && i === "iget" || r === "sget" && i === "sset" || r === "sset" && i === "sget" ? (e[n] = "true", false) : r ? true : (e[n] = i, false);
}
function Wi(e, t) {
...
ee.parseExportDefaultDeclaration = function() {
  ...
  if (this.type === b._function || (e = this.isAsyncFunction())) {
    var t = this.startNode();
    return this.next(), e && this.next(), this.parseFunction(t, Ur | ym, false, e);
...
ee.checkExport = function(e, t, n) {
  e && (typeof t != "string" && (t = t.type === "Identifier" ? t.name : t.value), Fr(e, t) && this.raiseRecoverable(n, "Duplicate export '" + t + "'"), e[t] = true);
};
...
ee.parseWithClause = function() {
  ...
  for (var t = {}, n = true; !this.eat(b.braceR); ) {
    if (n)
      n = false;
    else if (this.expect(b.comma), this.afterTrailingComma(b.braceR))
      break;
    var r = this.parseImportAttribute(), i = r.key.type === "Identifier" ? r.key.name : r.key.value;
    Fr(t, i) && this.raiseRecoverable(r.key.start, "Duplicate attribute key '" + i + "'"), t[i] = true, e.push(r);
  }
  return e;
};
...
Tt.parseBindingAtom = function() {
  if (this.options.ecmaVersion >= 6)
    switch (this.type) {
      case b.bracketL:
        var e = this.startNode();
        return this.next(), e.elements = this.parseBindingList(b.bracketR, true, true), this.finishNode(e, "ArrayPattern");
      case b.braceL:
...
Tt.parseBindingList = function(e, t, n, r) {
  for (var i = [], s = true; !this.eat(e); )
    if (s ? s = false : this.expect(b.comma), t && this.type === b.comma)
      i.push(null);
    else {
...
Tt.checkLValSimple = function(e, t, n) {
  ...
  switch (e.type) {
    case "Identifier":
      this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (r ? "Binding " : "Assigning to ") + e.name + " in strict mode"), r && (t === Fn && e.name === "let" && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), n && (Fr(n, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), n[e.name] = true), t !== gm && this.declareName(e.name, t, e.start));
      break;
    case "ChainExpression":
      this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
      break;
...
var We = {
  ...
  p_stat: new Wt("(", false),
  p_expr: new Wt("(", true),
  q_tmpl: new Wt("`", true, true, function(e) {
    return e.tryReadTemplateToken();
  }),
  f_stat: new Wt("function", false),
  f_expr: new Wt("function", true),
  f_expr_gen: new Wt("function", true, false, null, true),
  f_gen: new Wt("function", false, false, null, true)
};
var xr = Qe.prototype;
...
xr.braceIsBlock = function(e) {
  ...
  return t === We.f_expr || t === We.f_stat ? true : e === b.colon && (t === We.b_stat || t === We.b_expr) ? !t.isExpr : e === b._return || e === b.name && this.exprAllowed ? It.test(this.input.slice(this.lastTokEnd, this.start)) : e === b._else || e === b.semi || e === b.eof || e === b.parenR || e === b.arrow ? true : e === b.braceL ? t === We.b_stat : e === b._var || e === b._const || e === b.name ? false : !this.exprAllowed;
};
...
xr.updateContext = function(e) {
  var t, n = this.type;
  n.keyword && e === b.dot ? this.exprAllowed = false : (t = n.updateContext) ? t.call(this, e) : this.exprAllowed = n.beforeExpr;
};
...
b.braceL.updateContext = function(e) {
  this.context.push(this.braceIsBlock(e) ? We.b_stat : We.b_expr), this.exprAllowed = true;
};
b.dollarBraceL.updateContext = function() {
  this.context.push(We.b_tmpl), this.exprAllowed = true;
};
b.parenL.updateContext = function(e) {
  var t = e === b._if || e === b._for || e === b._with || e === b._while;
  this.context.push(t ? We.p_stat : We.p_expr), this.exprAllowed = true;
};
b.incDec.updateContext = function() {
};
b._function.updateContext = b._class.updateContext = function(e) {
  e.beforeExpr && e !== b._else && !(e === b.semi && this.curContext() !== We.p_stat) && !(e === b._return && It.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === b.colon || e === b.braceL) && this.curContext() === We.b_stat) ? this.context.push(We.f_expr) : this.context.push(We.f_stat), this.exprAllowed = false;
};
...
b.backQuote.updateContext = function() {
  this.curContext() === We.q_tmpl ? this.context.pop() : this.context.push(We.q_tmpl), this.exprAllowed = false;
};
...
b.name.updateContext = function(e) {
  var t = false;
  this.options.ecmaVersion >= 6 && e !== b.dot && (this.value === "of" && !this.exprAllowed || this.value === "yield" && this.inGeneratorContext()) && (t = true), this.exprAllowed = t;
};
var ce = Qe.prototype;
ce.checkPropClash = function(e, t, n) {
  if (!(this.options.ecmaVersion >= 9 && e.type === "SpreadElement") && !(this.options.ecmaVersion >= 6 && (e.computed || e.method || e.shorthand))) {
    ...
    var s = e.kind;
    if (this.options.ecmaVersion >= 6) {
      i === "__proto__" && s === "init" && (t.proto && (n ? n.doubleProto < 0 && (n.doubleProto = r.start) : this.raiseRecoverable(r.start, "Redefinition of __proto__ property")), t.proto = true);
      return;
    }
    i = "$" + i;
    var u = t[i];
...
ce.parseMaybeAssign = function(e, t, n) {
  ...
  var r = false, i = -1, s = -1, u = -1;
  t ? (i = t.parenthesizedAssign, s = t.trailingComma, u = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new ss(), r = true);
  ...
  if (n && (f = n.call(this, f, a, o)), this.type.isAssign) {
    ...
    return h.operator = this.value, this.type === b.eq && (f = this.toAssignable(f, false, t)), r || (t.parenthesizedAssign = t.trailingComma = t.doubleProto = -1), t.shorthandAssign >= f.start && (t.shorthandAssign = -1), this.type === b.eq ? this.checkLValPattern(f) : this.checkLValSimple(f), h.left = f, this.next(), h.right = this.parseMaybeAssign(e), u > -1 && (t.doubleProto = u), this.finishNode(h, "AssignmentExpression");
  } else
...
ce.parseExprOps = function(e, t) {
  var n = this.start, r = this.startLoc, i = this.parseMaybeUnary(t, false, false, e);
...
ce.parseExprOp = function(e, t, n, r, i) {
  ...
  if (s != null && (!i || this.type !== b._in) && s > r) {
    ...
    var o = this.value;
    this.next();
    var f = this.start, h = this.startLoc, m = this.parseExprOp(this.parseMaybeUnary(null, false, false, i), f, h, s, i), p = this.buildBinary(t, n, e, m, o, u || a);
...
ce.parseMaybeUnary = function(e, t, n, r) {
  ...
  if (this.isContextual("await") && this.canAwait)
    ...
    for (; this.type.postfix && !this.canInsertSemicolon(); ) {
      ...
      f.operator = this.value, f.prefix = false, f.argument = u, this.checkLValSimple(u), this.next(), u = this.finishNode(f, "UpdateExpression");
    }
  }
  if (!n && this.eat(b.starstar))
    if (t)
      ...
      return this.buildBinary(i, s, u, this.parseMaybeUnary(null, false, false, r), "**", false);
  else
    return u;
};
function Am(e) {
...
ce.parseExprSubscripts = function(e, t) {
  ...
  if (i.type === "ArrowFunctionExpression" && this.input.slice(this.lastTokStart, this.lastTokEnd) !== ")")
    return i;
  var s = this.parseSubscripts(i, n, r, false, t);
...
ce.parseSubscripts = function(e, t, n, r, i) {
  for (var s = this.options.ecmaVersion >= 8 && e.type === "Identifier" && e.name === "async" && this.lastTokEnd === e.end && !this.canInsertSemicolon() && e.end - e.start === 5 && this.potentialArrowAt === e.start, u = false; ; ) {
    var a = this.parseSubscript(e, t, n, r, s, u, i);
    if (a.optional && (u = true), a === e || a.type === "ArrowFunctionExpression") {
      if (u) {
...
ce.parseSubscriptAsyncArrow = function(e, t, n, r) {
  return this.parseArrowExpression(this.startNodeAt(e, t), n, true, r);
};
ce.parseSubscript = function(e, t, n, r, i, s, u) {
  ...
  if (f || o && this.type !== b.parenL && this.type !== b.backQuote || this.eat(b.dot)) {
    ...
    var C = this.parseExprList(b.parenR, this.options.ecmaVersion >= 8, false, m);
    if (i && !o && this.shouldParseAsyncArrow())
      return this.checkPatternErrors(m, false), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = p, this.awaitPos = A, this.awaitIdentPos = M, this.parseSubscriptAsyncArrow(t, n, C, u);
    this.checkExpressionErrors(m, true), this.yieldPos = p || this.yieldPos, this.awaitPos = A || this.awaitPos, this.awaitIdentPos = M || this.awaitIdentPos;
    ...
    _.tag = e, _.quasi = this.parseTemplate({ isTagged: true }), e = this.finishNode(_, "TaggedTemplateExpression");
  }
  return e;
};
ce.parseExprAtom = function(e, t, n) {
  ...
  switch (this.type) {
    ...
    case b.name:
      var s = this.start, u = this.startLoc, a = this.containsEsc, o = this.parseIdent(false);
      if (this.options.ecmaVersion >= 8 && !a && o.name === "async" && !this.canInsertSemicolon() && this.eat(b._function))
        return this.overrideContext(We.f_expr), this.parseFunction(this.startNodeAt(s, u), 0, false, true, t);
      if (i && !this.canInsertSemicolon()) {
        if (this.eat(b.arrow))
          return this.parseArrowExpression(this.startNodeAt(s, u), [o], false, t);
        if (this.options.ecmaVersion >= 8 && o.name === "async" && this.type === b.name && !a && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc))
          return o = this.parseIdent(false), (this.canInsertSemicolon() || !this.eat(b.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(s, u), [o], true, t);
      }
      return o;
    case b.regexp:
      var f = this.value;
    ...
    case b.bracketL:
      return r = this.startNode(), this.next(), r.elements = this.parseExprList(b.bracketR, true, true, e), this.finishNode(r, "ArrayExpression");
    case b.braceL:
      return this.overrideContext(We.b_expr), this.parseObj(false, e);
    case b._function:
...
ce.parseParenAndDistinguishExpression = function(e, t) {
  ...
  if (this.options.ecmaVersion >= 6) {
    this.next();
    var u = this.start, a = this.startLoc, o = [], f = true, h = false, m = new ss(), p = this.yieldPos, A = this.awaitPos, M;
    for (this.yieldPos = 0, this.awaitPos = 0; this.type !== b.parenR; )
      if (f ? f = false : this.expect(b.comma), s && this.afterTrailingComma(b.parenR, true)) {
        h = true;
        break;
        ...
        o.push(this.parseMaybeAssign(false, m, this.parseParenItem));
    var C = this.lastTokEnd, F = this.lastTokEndLoc;
    if (this.expect(b.parenR), e && this.shouldParseArrow(o) && this.eat(b.arrow))
      return this.checkPatternErrors(m, false), this.checkYieldAwaitInDefaultParams(), this.yieldPos = p, this.awaitPos = A, this.parseParenArrowList(n, r, o, t);
    (!o.length || h) && this.unexpected(this.lastTokStart), M && this.unexpected(M), this.checkExpressionErrors(m, true), this.yieldPos = p || this.yieldPos, this.awaitPos = A || this.awaitPos, o.length > 1 ? (i = this.startNodeAt(u, a), i.expressions = o, this.finishNodeAt(i, "SequenceExpression", C, F)) : i = o[0];
  } else
...
ce.parseParenArrowList = function(e, t, n, r) {
  return this.parseArrowExpression(this.startNodeAt(e, t), n, false, r);
};
var uP = [];
ce.parseNew = function() {
  ...
  return e.callee = this.parseSubscripts(this.parseExprAtom(null, false, true), r, i, true, false), this.eat(b.parenL) ? e.arguments = this.parseExprList(b.parenR, this.options.ecmaVersion >= 8, false) : e.arguments = uP, this.finishNode(e, "NewExpression");
};
...
ce.parseProperty = function(e, t) {
  ...
  if (this.options.ecmaVersion >= 9 && this.eat(b.ellipsis))
    return e ? (n.argument = this.parseIdent(false), this.type === b.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element"), this.finishNode(n, "RestElement")) : (n.argument = this.parseMaybeAssign(false, t), this.type === b.comma && t && t.trailingComma < 0 && (t.trailingComma = this.start), this.finishNode(n, "SpreadElement"));
  this.options.ecmaVersion >= 6 && (n.method = false, n.shorthand = false, (e || t) && (s = this.start, u = this.startLoc), e || (r = this.eat(b.star)));
  var a = this.containsEsc;
  return this.parsePropertyName(n), !e && !a && this.options.ecmaVersion >= 8 && !r && this.isAsyncProp(n) ? (i = true, r = this.options.ecmaVersion >= 9 && this.eat(b.star), this.parsePropertyName(n)) : i = false, this.parsePropertyValue(n, e, r, i, s, u, t, a), this.finishNode(n, "Property");
};
...
ce.parseMethod = function(e, t, n) {
  ...
  return this.initFunction(r), this.options.ecmaVersion >= 6 && (r.generator = e), this.options.ecmaVersion >= 8 && (r.async = !!t), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(ba(t, r.generator) | ya | (n ? pm : 0)), this.expect(b.parenL), r.params = this.parseBindingList(b.parenR, false, this.options.ecmaVersion >= 8), this.checkYieldAwaitInDefaultParams(), this.parseFunctionBody(r, false, true, false), this.yieldPos = i, this.awaitPos = s, this.awaitIdentPos = u, this.finishNode(r, "FunctionExpression");
};
ce.parseArrowExpression = function(e, t, n, r) {
  var i = this.yieldPos, s = this.awaitPos, u = this.awaitIdentPos;
  return this.enterScope(ba(n, false) | fm), this.initFunction(e), this.options.ecmaVersion >= 8 && (e.async = !!n), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, e.params = this.toAssignableList(t, true), this.parseFunctionBody(e, true, false, r), this.yieldPos = i, this.awaitPos = s, this.awaitIdentPos = u, this.finishNode(e, "ArrowFunctionExpression");
};
ce.parseFunctionBody = function(e, t, n, r) {
  var i = t && this.type !== b.braceL, s = this.strict, u = false;
  if (i)
    e.body = this.parseMaybeAssign(r), e.expression = true, this.checkParams(e, false);
  else {
    ...
    var o = this.labels;
    this.labels = [], u && (this.strict = true), this.checkParams(e, !s && !u && !t && !n && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, gm), e.body = this.parseBlock(false, void 0, u && !s), e.expression = false, this.adaptDirectivePrologue(e.body.body), this.labels = o;
  }
  this.exitScope();
};
...
ce.parseExprList = function(e, t, n, r) {
  for (var i = [], s = true; !this.eat(e); ) {
    if (s)
      ...
      break;
    var u = void 0;
    n && this.type === b.comma ? u = null : this.type === b.ellipsis ? (u = this.parseSpread(r), r && this.type === b.comma && r.trailingComma < 0 && (r.trailingComma = this.start)) : u = this.parseMaybeAssign(false, r), i.push(u);
  }
  return i;
};
...
ce.parseYield = function(e) {
  ...
  var t = this.startNode();
  return this.next(), this.type === b.semi || this.canInsertSemicolon() || this.type !== b.star && !this.type.startsExpr ? (t.delegate = false, t.argument = null) : (t.delegate = this.eat(b.star), t.argument = this.parseMaybeAssign(e)), this.finishNode(t, "YieldExpression");
};
...
var oP = "Gara Garay Gukh Gurung_Khema Hrkt Katakana_Or_Hiragana Kawi Kirat_Rai Krai Nag_Mundari Nagm Ol_Onal Onao Sunu Sunuwar Todhri Todr Tulu_Tigalari Tutg Unknown Zzzz";
var Mm = "ASCII ASCII_Hex_Digit AHex Alphabetic Alpha Any Assigned Bidi_Control Bidi_C Bidi_Mirrored Bidi_M Case_Ignorable CI Cased Changes_When_Casefolded CWCF Changes_When_Casemapped CWCM Changes_When_Lowercased CWL Changes_When_NFKC_Casefolded CWKCF Changes_When_Titlecased CWT Changes_When_Uppercased CWU Dash Default_Ignorable_Code_Point DI Deprecated Dep Diacritic Dia Emoji Emoji_Component Emoji_Modifier Emoji_Modifier_Base Emoji_Presentation Extender Ext Grapheme_Base Gr_Base Grapheme_Extend Gr_Ext Hex_Digit Hex IDS_Binary_Operator IDSB IDS_Trinary_Operator IDST ID_Continue IDC ID_Start IDS Ideographic Ideo Join_Control Join_C Logical_Order_Exception LOE Lowercase Lower Math Noncharacter_Code_Point NChar Pattern_Syntax Pat_Syn Pattern_White_Space Pat_WS Quotation_Mark QMark Radical Regional_Indicator RI Sentence_Terminal STerm Soft_Dotted SD Terminal_Punctuation Term Unified_Ideograph UIdeo Uppercase Upper Variation_Selector VS White_Space space XID_Continue XIDC XID_Start XIDS";
var Cm = Mm + " Extended_Pictographic";
var vm = Cm;
var Pm = vm + " EBase EComp EMod EPres ExtPict";
var Dm = Pm;
var cP = Dm;
var lP = {
  9: Mm,
...
var fP = "Basic_Emoji Emoji_Keycap_Sequence RGI_Emoji_Modifier_Sequence RGI_Emoji_Flag_Sequence RGI_Emoji_Tag_Sequence RGI_Emoji_ZWJ_Sequence RGI_Emoji";
var hP = {
  9: "",
  10: "",
  11: "",
...
for (Zs = 0, Bo = [9, 10, 11, 12, 13, 14]; Zs < Bo.length; Zs += 1) {
  gP = Bo[Zs];
  mP(gP);
}
var gP;
...
cn.prototype.reset = function(t, n, r) {
  ...
  this.start = t | 0, this.source = n + "", this.flags = r, i && this.parser.options.ecmaVersion >= 15 ? (this.switchU = true, this.switchV = true, this.switchN = true) : (this.switchU = s && this.parser.options.ecmaVersion >= 6, this.switchV = false, this.switchN = s && this.parser.options.ecmaVersion >= 9);
};
...
J.validateRegExpFlags = function(e) {
  for (var t = e.validFlags, n = e.flags, r = false, i = false, s = 0; s < n.length; s++) {
    var u = n.charAt(s);
    t.indexOf(u) === -1 && this.raise(e.start, "Invalid regular expression flag"), n.indexOf(u, s + 1) > -1 && this.raise(e.start, "Duplicate regular expression flag"), u === "u" && (r = true), u === "v" && (i = true);
  }
...
J.validateRegExpPattern = function(e) {
  this.regexp_pattern(e), !e.switchN && this.options.ecmaVersion >= 9 && yP(e.groupNames) && (e.switchN = true, this.regexp_pattern(e));
};
...
J.regexp_eatBracedQuantifier = function(e, t) {
  ...
  if (e.eat(
    ...
    if (this.regexp_eatDecimalDigits(e) && (r = e.lastIntValue, e.eat(
      ...
      return i !== -1 && i < r && !t && e.raise("numbers out of order in {} quantifier"), true;
...
J.regexp_eatSyntaxCharacter = function(e) {
  var t = e.current();
  return _m(t) ? (e.lastIntValue = t, e.advance(), true) : false;
};
function _m(e) {
...
J.regexp_eatRegExpIdentifierStart = function(e) {
  ...
  return e.advance(n), r === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, n) && (r = e.lastIntValue), bP(r) ? (e.lastIntValue = r, true) : (e.pos = t, false);
};
function bP(e) {
  return vn(e, true) || e === 36 || e === 95;
}
J.regexp_eatRegExpIdentifierPart = function(e) {
  var t = e.pos, n = this.options.ecmaVersion >= 11, r = e.current(n);
  return e.advance(n), r === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, n) && (r = e.lastIntValue), MP(r) ? (e.lastIntValue = r, true) : (e.pos = t, false);
};
function MP(e) {
  return yr(e, true) || e === 36 || e === 95 || e === 8204 || e === 8205;
}
...
J.regexp_eatZero = function(e) {
  return e.current() === 48 && !as(e.lookahead()) ? (e.lastIntValue = 0, e.advance(), true) : false;
};
...
J.regexp_eatControlLetter = function(e) {
  var t = e.current();
  return km(t) ? (e.lastIntValue = t % 32, e.advance(), true) : false;
};
function km(e) {
    ...
    if (this.regexp_eatFixedHexDigits(e, 4)) {
      ...
      if (r && i >= 55296 && i <= 56319) {
        ...
        if (e.eat(
          ...
          if (u >= 56320 && u <= 57343)
            return e.lastIntValue = (i - 55296) * 1024 + (u - 56320) + 65536, true;
        }
...
J.regexp_eatCharacterClass = function(e) {
  if (e.eat(
    ...
    return e.eat(
      93
      /* ] */
    ) || e.raise("Unterminated character class"), t && n === _t && e.raise("Negated character class may contain strings"), true;
  }
  return false;
};
...
J.regexp_eatClassSetRange = function(e) {
  ...
  if (this.regexp_eatClassSetCharacter(e)) {
    ...
    if (e.eat(
      ...
      return n !== -1 && r !== -1 && n > r && e.raise("Range out of order in character class"), true;
    }
    e.pos = t;
  }
  return false;
...
J.regexp_eatClassSetCharacter = function(e) {
  ...
  var n = e.current();
  return n < 0 || n === e.lookahead() && DP(n) || FP(n) ? false : (e.advance(), e.lastIntValue = n, true);
};
function DP(e) {
...
J.regexp_eatClassSetReservedPunctuator = function(e) {
  var t = e.current();
  return EP(t) ? (e.lastIntValue = t, e.advance(), true) : false;
};
function EP(e) {
...
J.regexp_eatClassControlLetter = function(e) {
  var t = e.current();
  return as(t) || t === 95 ? (e.lastIntValue = t % 32, e.advance(), true) : false;
};
...
Me.readToken_numberSign = function() {
  ...
  if (e >= 13 && (++this.pos, t = this.fullCharCodeAtPos(), vn(t, true) || t === 92))
...
Me.readNumber = function(e) {
  ...
  n && /[89]/.test(this.input.slice(t, this.pos)) && (n = false), r === 46 && !n && (++this.pos, this.readInt(10), r = this.input.charCodeAt(this.pos)), (r === 69 || r === 101) && !n && (r = this.input.charCodeAt(++this.pos), (r === 43 || r === 45) && ++this.pos, this.readInt(10) === null && this.raise(t, "Invalid number")), vn(this.fullCharCodeAtPos()) && this.raise(this.pos, "Identifier directly after number");
...
Me.readString = function(e) {
  for (var t = "", n = ++this.pos; ; ) {
    ...
    if (r === e)
      break;
    r === 92 ? (t += this.input.slice(n, this.pos), t += this.readEscapedChar(false), n = this.pos) : r === 8232 || r === 8233 ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (Dr(r) && this.raise(this.start, "Unterminated string constant"), ++this.pos);
  }
...
Me.readWord1 = function() {
  ...
  for (var e = "", t = true, n = this.pos, r = this.options.ecmaVersion >= 6; this.pos < this.input.length; ) {
...
function zm() {
  ...
  function i(s) {
    s || (s = {}), this._file = t.getArg(s, "file", null), this._sourceRoot = t.getArg(s, "sourceRoot", null), this._skipValidation = t.getArg(s, "skipValidation", false), this._sources = new n(), this._names = new n(), this._mappings = new r(), this._sourcesContents = null;
  }
...
function RP() {
  return Wo || (Wo = 1, (function(e) {
    ...
    function t(n, r, i, s, u, a) {
      var o = Math.floor((r - n) / 2) + n, f = u(i, s[o], true);
...
function ZP() {
  ...
  function u(f, h) {
    ...
    }), this._names = n.fromArray(M.map(String), true), this._sources = n.fromArray(A, true), this._absoluteSources = this._sources.toArray().map(function(L) {
  ...
  u.prototype = Object.create(s.prototype), u.prototype.consumer = s, u.prototype._findSourceIndex = function(f) {
    ...
    var p = Object.create(u.prototype), A = p._names = n.fromArray(h._names.toArray(), true), M = p._sources = n.fromArray(h._sources.toArray(), true);
  ...
  return o.prototype = Object.create(s.prototype), o.prototype.constructor = s, o.prototype._version = 3, Object.defineProperty(o.prototype, "sources", {
    ...
    for (var p = 0; p < this._sections.length; p++) {
      var A = this._sections[p], M = A.consumer.sourceContentFor(h, true);
      if (M)
        return M;
    }
    if (m)
...
function XP() {
  ...
  function s(u, a, o, f, h) {
    this.children = [], this.sourceContents = {}, this.line = u ?? null, this.column = a ?? null, this.source = o ?? null, this.name = h ?? null, this[i] = true, f != null && this.add(f);
  }
  return s.fromStringWithSourceMap = function(a, o, f) {
    ...
    var o = {
      ...
      line: 1,
      column: 0
    }, f = new e(a), h = false, m = null, p = null, A = null, M = null;
    return this.walk(function(C, F) {
      o.code += C, F.source !== null && F.line !== null && F.column !== null ? ((m !== F.source || p !== F.line || A !== F.column || M !== F.name) && f.addMapping({
        ...
        name: F.name
      }), m = F.source, p = F.line, A = F.column, M = F.name, h = true) : h && (f.addMapping({
        generated: {
          line: o.line,
          column: o.column
        }
      ...
      for (var _ = 0, k = C.length; _ < k; _++)
        C.charCodeAt(_) === r ? (o.line++, o.column = 0, _ + 1 === k ? (m = null, h = false) : h && f.addMapping({
          source: F.source,
          original: {
            line: F.line,
            column: F.column
...
var OP = "escodegen";
var zP = "ECMAScript code generator";
var jP = "http://github.com/estools/escodegen";
var $P = "escodegen.js";
var qP = { esgenerate: "./bin/esgenerate.js", escodegen: "./bin/escodegen.js" };
var HP = ["LICENSE.BSD", "README.md", "bin", "escodegen.js", "package.json"];
var KP = "2.1.0";
var YP = { node: ">=6.0" };
var JP = [{ name: "Yusuke Suzuki", email: "utatane.tea@gmail.com", web: "http://github.com/Constellation" }];
var UP = { type: "git", url: "http://github.com/estools/escodegen.git" };
var QP = { estraverse: "^5.2.0", esutils: "^2.0.2", esprima: "^4.0.1" };
var eD = { "source-map": "~0.6.1" };
var tD = { acorn: "^8.0.4", bluebird: "^3.4.7", "bower-registry-client": "^1.0.0", chai: "^4.2.0", "chai-exclude": "^2.0.2", "commonjs-everywhere": "^0.9.7", gulp: "^4.0.2", "gulp-eslint": "^6.0.0", "gulp-mocha": "^7.0.2", minimist: "^1.2.5", optionator: "^0.9.1", semver: "^7.3.4" };
var nD = "BSD-2-Clause";
var rD = { test: "gulp travis", "unit-test": "gulp test", lint: "gulp lint", release: "node tools/release.js", "build-min": "./node_modules/.bin/cjsify -ma path: tools/entry-point.js > escodegen.browser.min.js", build: "./node_modules/.bin/cjsify -a path: tools/entry-point.js > escodegen.browser.js" };
var iD = {
  name: OP,
  description: zP,
  homepage: jP,
...
`,
      ...
      function xn(c) {
        ...
        if (d = c.toString(), c.source) {
          if (g = d.match(/\/([^/]*)$/), !g)
            return d;
          for (y = g[1], d = "", Z = false, Y = false, P = 0, I = c.source.length; P < I; ++P)
            R = c.source.charCodeAt(P), Y ? (d += Nt(R, Y), Y = false) : (Z ? R === 93 && (Z = false) : R === 47 ? d += "\\" : R === 91 && (Z = true), d += Nt(R, Y), Y = R === 92);
          return "/" + d + "/" + y;
        }
        return d;
      }
      ...
      function be(c, g) {
        ...
        return g.loc == null ? new i(null, null, B, c, g.name || null) : new i(g.loc.start.line, g.loc.start.column, B === true ? g.loc.source || null : B, c, g.name || null);
      }
      function _e() {
        return C || " ";
      }
...
` && P++;
      ...
      Ie.prototype.generatePattern = function(c, g, d) {
        ...
        var g, d, y, P;
        if (P = false, c.type === t.ArrowFunctionExpression && !c.rest && (!c.defaults || c.defaults.length === 0) && c.params.length === 1 && c.params[0].type === t.Identifier)
          y = [Qt(c, true), rt(c.params[0])];
        else {
          for (y = c.type === t.ArrowFunctionExpression ? [Qt(c, false)] : [], y.push("("), c.defaults && (P = true), g = 0, d = c.params.length; g < d; ++g)
...
` && (P = ["{"])), c.body[0].leadingComments || Ut(c.range[0], c.body[0].range[0], P)), R > 0 && !c.body[R - 1].trailingComments && !c.body[R].leadingComments && Ut(c.body[R - 1].range[1], c.body[R].range[0], P)), R === Z - 1 && (fe |= ie), c.body[R].leadingComments && T ? Y = I.generateStatement(c.body[R], fe) : Y = Oe(I.generateStatement(c.body[R], fe)), P.push(Y), Ge(be(Y).toString()) || T && R < Z - 1 && c.body[R + 1].leadingComments || P.push(M), T && R === Z - 1 && (c.body[R].trailingComments || Ut(c.body[R].range[1], c.range[1], P));
        ...
        ExpressionStatement: function(c, g) {
          ...
          function P(Z) {
            var Y;
            return Z.slice(0, 5) !== "class" ? false : (Y = Z.charCodeAt(5), Y === 123 || u.code.isWhiteSpace(Y) || u.code.isLineTerminator(Y));
          }
          function I(Z) {
            var Y;
            return Z.slice(0, 8) !== "function" ? false : (Y = Z.charCodeAt(8), Y === 40 || u.code.isWhiteSpace(Y) || Y === 42 || u.code.isLineTerminator(Y));
          }
          function R(Z) {
            var Y, fe, Te;
            ...
            for (fe = 6, Te = Z.length; fe < Te && u.code.isWhiteSpace(Z.charCodeAt(fe)); ++fe)
              ;
            return fe === Te || Z.slice(fe, fe + 8) !== "function" ? false : (Y = Z.charCodeAt(fe + 8), Y === 40 || u.code.isWhiteSpace(Y) || Y === 42 || u.code.isLineTerminator(Y));
          }
...
` : ""], R = Ke, P = 0; P < I; ++P)
        ...
        ArrayPattern: function(c, g, d) {
          return this.ArrayExpression(c, g, d, true);
        },
        ArrayExpression: function(c, g, d, y) {
          var P, I, R = this;
          return c.elements.length ? (I = y ? false : c.elements.length > 1, P = ["[", I ? M : ""], Be(function(Z) {
            var Y, fe;
        ...
        ObjectPattern: function(c, g, d) {
          ...
          if (!c.properties.length)
            return "{}";
          if (R = false, c.properties.length === 1)
            Z = c.properties[0], Z.type === t.Property && Z.value.type !== t.Identifier && (R = true);
          else
...
` && (d = B ? be(d).replaceRight(/\s+$/, "") : y.replace(/\s+$/, "")), be(d, c);
      ...
      H = {
        ...
        parentheses: false,
        semicolons: false
      }, X = bt().format, e.version = iD.version, e.generate = Tr, e.attachComments = s.attachComments, e.Precedence = dt({}, n), e.browser = false, e.FORMAT_MINIFY = H, e.FORMAT_DEFAULTS = X;
    })();
  })(Xs)), Xs;
}
var uD = sD();
  ...
  visit(t, n, r, i) {
    if (t) {
      if (this.enter) {
        ...
        this.should_skip = false, this.should_remove = false, this.replacement = null, this.enter.call(this.context, t, n, r, i), this.replacement && (t = this.replacement, this.replace(n, r, i, t)), this.should_remove && this.remove(n, r, i);
      ...
      if (this.leave) {
        ...
        this.replacement = null, this.should_remove = false, this.leave.call(this.context, t, n, r, i), this.replacement && (t = this.replacement, this.replace(n, r, i, t)), this.should_remove && this.remove(n, r, i);
...
function fD(e, t = {}) {
  var _a2;
  const { wrapAsync: n = false, addReturn: r = true, emitMiniLocations: i = true, emitWidgets: s = true } = t;
  let u = SP(e, {
    ecmaVersion: 2022,
    ...
    enter(p, A) {
      ...
      if (dD(p))
        return s && f.push({
          ...
          // don't use value!
          min: ((_a3 = p.arguments[1]) == null ? void 0 : _a3.value) ?? 0,
          max: ((_b2 = p.arguments[2]) == null ? void 0 : _b2.value) ?? 1,
          step: (_c2 = p.arguments[3]) == null ? void 0 : _c2.value,
          type: "slider"
        }), this.replace(gD(p));
      if (mD(p)) {
  ...
  else if (!((_a2 = h == null ? void 0 : h[h.length - 1]) == null ? void 0 : _a2.expression))
...
function mD(e) {
  var _a2;
  return e.type === "CallExpression" && jm.includes((_a2 = e.callee.property) == null ? void 0 : _a2.name);
}
function gD(e) {
...
var Yo = (e, t) => Array(Math.abs(t) + 1).join(e);
...
var BD = "([-+]?\\d+)(d{1,4}|m|M|P|A{1,4})";
var _D = "(AA|A|P|M|m|d|dd)([-+]?\\d+)";
var kD = new RegExp(
  "^" + BD + "|" + _D + "$"
);
function VD(e) {
...
var Qo = (e, t) => Array(Math.abs(t) + 1).join(e);
...
var RD = (e) => "CDEFGAB".charAt(e);
var os = (e) => e < 0 ? Qo("b", -e) : Qo("#", e);
var Fa = (e) => e[0] === "b" ? -e.length : e.length;
function Fe(e) {
...
var tc = (e, t) => Array(t + 1).join(e);
var zD = /^(_{1,}|=|\^{1,}|)([abcdefgABCDEFG])([,']*)$/;
function eg(e) {
  const t = zD.exec(e);
...
var wa = (e) => Number(e).toString(2).padStart(12, "0");
var nc = (e) => parseInt(e, 2);
var u5 = /^[01]{12}$/;
function Sa(e) {
  return u5.test(e);
}
var a5 = (e) => typeof e == "number" && e >= 0 && e <= 4095;
var o5 = (e) => e && Sa(e.chroma);
var rc = { [In.chroma]: In };
function ut(e) {
...
var c5 = ut;
var sg = (e) => ut(e).chroma;
var l5 = (e) => ut(e).intervals;
var f5 = (e) => ut(e).setNum;
var h5 = [
  "1P",
  "2m",
  "2M",
...
var ds = (e) => (t) => !!(t & e);
var w5 = ds(ps.anyThirds);
var S5 = ds(ps.perfectFifth);
var B5 = ds(ps.anySeventh);
var _5 = ds(ps.nonPerfectFifths);
function k5(e) {
...
function I5(e, t, n) {
  const r = e[0], i = Fe(r).chroma, s = E5(e), u = Ba(e, false), a = [];
...
var cg = [0, 2, 4, 5, 7, 9, 11];
var lg = ({ step: e, alt: t }) => (cg[e] + t + 120) % 12;
var ka = ({ step: e, alt: t, oct: n, dir: r = 1 }) => r * (cg[e] + t + 12 * (n === void 0 ? -100 : n));
var fg = (e) => {
  const t = ka(e);
...
var ic = (e, t) => Array(Math.abs(t) + 1).join(e);
var Cu = { empty: true, name: "", acc: "" };
var L5 = "([-+]?\\d+)(d{1,4}|m|M|P|A{1,4})";
var R5 = "(AA|A|P|M|m|d|dd)([-+]?\\d+)";
var G5 = new RegExp(
  "^" + L5 + "|" + R5 + "$"
);
function Va(e) {
...
var ac = (e, t) => Array(Math.abs(t) + 1).join(e);
var mg = { empty: true, name: "", pc: "", acc: "" };
var oc = /* @__PURE__ */ new Map();
var Ia = (e) => "CDEFGAB".charAt(e);
var Ta = (e) => e < 0 ? ac("b", -e) : ac("#", e);
var Na = (e) => e[0] === "b" ? -e.length : e.length;
function sn(e) {
...
var Ag = Object.freeze(Object.defineProperty({
  __proto__: null,
  accToAlt: Na,
  altToAcc: Ta,
  chroma: lg,
...
var x9 = (e) => Xa(e).value;
var w9 = (e) => Xa(e).fraction;
var S9 = { names: D9, shorthands: F9, get: Xa, value: x9, fraction: w9 };
function B9(e, t, n) {
  Ps.push({
    empty: false,
    dots: "",
...
var G9 = [1, 2, 2, 3, 3, 4, 5, 5, 6, 6, 7, 7];
var Z9 = "P m M m M P d P m M m M".split(" ");
function X9(e) {
  const t = e < 0 ? -1 : 1, n = Math.abs(e), r = n % 12, i = Math.floor(n / 12);
  return t * (G9[r] + 7 * i) + Z9[r];
}
var W9 = cs;
var Fg = Eg((e, t) => [e[0] + t[0], e[1] + t[1]]);
var O9 = (e) => (t) => Fg(e, t);
var z9 = Eg((e, t) => [e[0] - t[0], e[1] - t[1]]);
function j9(e, t) {
  const n = Dg(e);
  if (n.empty)
    return "";
...
var K9 = "C C# D D# E F F# G G# A A# B".split(" ");
var Y9 = "C Db D Eb E F Gb G Ab A Bb B".split(" ");
function Zn(e, t = {}) {
  if (isNaN(e) || e === -1 / 0 || e === 1 / 0) return "";
  e = Math.round(e);
  const r = (t.sharps === true ? K9 : Y9)[e % 12];
  if (t.pitchClass)
    return r;
...
var n7 = ["C", "D", "E", "F", "G", "A", "B"];
var Bg = (e) => e.name;
var _g = (e) => e.map(Fe).filter((t) => !t.empty);
function r7(e) {
...
function h7(e) {
  return Zn(Wa(e), { sharps: true });
}
function p7(e) {
  return Zn(e, { sharps: true });
}
var d7 = cs;
var jt = Ht;
var m7 = Ht;
...
var ja = (e, t) => e.height - t.height;
var M7 = (e, t) => t.height - e.height;
function Tg(e, t) {
...
var Rg = { empty: true, name: "", chordType: "" };
var cc = {};
function Nn(e) {
...
var Gg = "I II III IV V VI VII";
var Ds = Gg.split(" ");
var x7 = Gg.toLowerCase().split(" ");
function w7(e) {
  const [t, n, r, i] = E7(e);
  if (!r)
    return Rg;
...
var tu = (e, t, n = "") => t.map((r, i) => `${e[i]}${n}${r}`);
...
var G7 = { majorKey: N7, majorTonicFromKeySignature: R7, minorKey: L7 };
var Z7 = rn;
function X7(e) {
  const t = rn(e);
  return t.empty ? "" : t.simple + t.q;
...
var H7 = Og($a.map((e) => e[4]));
var K7 = Og($a.map((e) => e[5]));
function zg(e, t) {
  const n = Jn(t), r = Jn(e);
...
var rF = { numeric: jg, chromatic: nF };
var iF = {
  empty: true,
  name: "",
  type: "",
...
var gF = ["4/4", "3/4", "2/4", "2/2", "12/8", "9/8", "6/8", "3/8"];
function yF() {
  return gF.slice();
}
var AF = /^(\d*\d(?:\+\d)*)\/(\d+)$/;
...
var MF = { names: yF, parse: Ha, get: bF };
var CF = (e) => Math.log(e) / Math.log(2) % 1 === 0;
function vF([e, t]) {
...
var wF = ["C", "Db", "D", "Eb", "E", "F", "Gb", "G", "Ab", "A", "Bb", "B"];
var SF = ["c", "db", "d", "eb", "e", "f", "gb", "g", "ab", "a", "bb", "b"];
var BF = ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"];
var _F = { b: -1, "#": 1 };
var kF = (e) => {
  const [t, ...n] = e.split("");
...
var { transpose: XF, trans: WF } = N(["transpose", "trans"], function(t, n) {
  return n.withHap((r) => {
...
var { scaleTranspose: OF, scaleTrans: zF, strans: jF } = N(
...
function Yg() {
  if (mc) return jr;
  mc = 1, jr.__esModule = true, jr.getBestVoicing = void 0;
  function e(t) {
...
function Ug() {
  if (gc) return qr;
  gc = 1, qr.__esModule = true, qr.tokenizeChord = void 0;
  function e(t) {
...
function qF() {
  if (yc) return $r;
  yc = 1, $r.__esModule = true, $r.voicingsInRange = void 0;
  var e = Jg, t = Qg(), n = Ug();
  function r(i, s, u) {
...
function HF() {
  if (bc) return Hr;
  bc = 1, Hr.__esModule = true, Hr.minTopNoteDiff = void 0;
  var e = Jg;
  function t(n, r) {
    if (!r)
      return n[0];
...
var { dictionaryVoicing: JF, minTopNoteDiff: UF } = Cc.default || Cc;
var QF = {
  m7: ["3m 5P 7m 9M", "7m 9M 10m 12P"],
  7: ["3M 6M 7m 9M", "7m 9M 10M 13M"],
  "^7": ["3M 5P 7M 9M", "7M 9M 10M 12P"],
...
var e2 = "ireal";
var t2 = (e) => e2 = e;
var rE = (e, t) => n2(e, kr[e].dictionary, t);
var n2 = (e, t, n = ["F3", "A4"]) => {
...
var qn;
function hE(e = {}) {
  Nd(), e.miniAllStrings !== false && rm();
  const { prebake: t, ...n } = e;
  return qn = Hd({ ...n, transpiler: fD }), Eu = (async () => (await fE(), await (t == null ? void 0 : t()), qn))(), Ni(() => qn.scheduler.now()), Eu;
}
