...
__export(index_exports, {
  StrudelVisualizer: () => StrudelVisualizer,
  interpret: () => interpret,
  parse: () => parse,
  tokenize: () => tokenize,
  useStrudelVisualizer: () => useStrudelVisualizer
});
...
function useStrudelVisualizer(options) {
  ...
  const [frequencyData, setFrequencyData] = (0, import_react.useState)(null);
  const [parseResult, setParseResult] = (0, import_react.useState)(null);
  const [events, setEvents] = (0, import_react.useState)([]);
  const animationFrameRef = (0, import_react.useRef)(void 0);
...
function StrudelVisualizer(props) {
  ...
  const animationRef = (0, import_react2.useRef)(void 0);
  const barsRef = (0, import_react2.useRef)(new Array(barCount).fill(0));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        hasErrors && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "div",
          {
            style: {
              position: "absolute",
